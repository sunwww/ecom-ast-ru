...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
	...
	<tiles:put name='side' type='string'>
		<msh:sideMenu title="Добавить">
			<msh:sideLink key='ALT+N' roles="ROLE/Create" params="" action="/entityPrepareCreate-asset_assetWorkcard" title="Рабочая карточка актива" name="Рабочая карточка актива" />
		</msh:sideMenu>
	</tiles:put>
