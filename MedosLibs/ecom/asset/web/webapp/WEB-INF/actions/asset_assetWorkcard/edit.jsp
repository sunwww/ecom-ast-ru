...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
	<tiles:put name="body" type="string">
		<msh:form action="/entitySaveGoView-asset_assetWorkcard.do" defaultField="">
	...
	<tiles:put name="side" type="string">
		<msh:ifFormTypeAreViewOrEdit formName="asset_assetWorkcardForm">
			<msh:sideMenu>
				<msh:sideLink key="ALT+2" params="id" action="/entityParentEdit-asset_assetWorkcard" name="Изменить" title="Изменить" roles=""/>
				<msh:sideLink key="ALT+DEL" params="id" action="/entityParentDelete-asset_assetWorkcard" name="Удалить" title="Удалить" roles=""/>
			</msh:sideMenu>
