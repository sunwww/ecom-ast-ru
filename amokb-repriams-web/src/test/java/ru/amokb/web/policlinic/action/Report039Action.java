package ru.amokb.web.policlinic.action;
...
//import ru.amokb.repriams.ejb.service.IReportQueryService;
...
public class Report039Action extends BaseAction {
	...
	public ActionForward myExecute(ActionMapping aMapping, ActionForm aForm, HttpServletRequest aRequest, HttpServletResponse aResponse) throws Exception {
		...
		IReportQueryService repService  = Injection.find(aRequest).getService(IReportQueryService.class) ;
