...
public class ListVocWorkFunctionAction  extends BaseAction {
    public ActionForward myExecute(ActionMapping aMapping, ActionForm aForm, HttpServletRequest aRequest, HttpServletResponse aResponse) throws Exception {
		...
		sql.append("select vwf.id||'&vocWorkFunction='||vwf.id||'").append(addParam).append("' as vwfid,vwf.code as vwfcode,replace(replace(upper(vwf.name),'ВРАЧ-',''),'ВРАЧ ','') as vwfname") ;
