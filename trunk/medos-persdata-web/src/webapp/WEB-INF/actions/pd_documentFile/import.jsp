...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
    ...
    <tiles:put name='title' type='string'>
        <ecom:titleTrail mainMenu="Patient" beginForm="pd_comingDocumentForm" title="Импорт документа"/>
    </tiles:put>


    <tiles:put name='body' type='string'>
        <msh:form action="documentFile-preView.do"  defaultField="typeName" fileTransferSupports="true">
    ...
    <tiles:put name="javascript" type="string">
        <script type="text/javascript">
        	...
        	function getImage() {
	        	$('mainForm').action ='documentFile-viewImage.do' ;
