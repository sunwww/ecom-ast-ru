...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
    ...
    <msh:form action="entityParentSaveGoView-smo_ticket.do" defaultField="dateStart" guid="77bf3d00-cfc6-49eb-9751-76e82d38751c">
      ...
      <msh:panel colsWidth="1%,1%,1%,97%">
        ...
        <msh:row guid="0489132a-531c-47bc-abfc-1528e774bbfe">
          <msh:autoComplete vocName="vocIdc10ticket" property="concludingMkb" label="Код МКБ" fieldColSpan="3" horizontalFill="true" guid="9818fb43-33d1-4fe9-a0b4-2b04a9eee955" />
        </msh:row>
        <msh:row guid="0489132a-531c-47bc-abfc-1528e774bbfe">
  ...
  <tiles:put name="javascript" type="string">
    ...
    function viewProtocolByMedcard(d) {
  	  ...
  	  getDefinition("js-smo_visitProtocol-infoByMedcardShort.do?id="+m.value, null); 
    }    
