		...
		<table class='mainMenu'>
			<tr>
				...
				<ul style='list-style: none outside none; '>
					...
					<li><msh:link roles="/Policy/Mis/Journal/263injunction" action="stac_direct_in_fond.do">
                             263 приказ
                        </msh:link></li>
					<li><msh:link roles="/Policy/Mis/MedCase/Stac/Journal/AddressList" action="stac_address_list.do">
                             Адресные листки
                        </msh:link></li>
			...
			<tr>
				...
				<div class='menu'>
					...
					<ul style='list-style: none outside none; '>
						...
						<li><msh:link action="smo_journal_openSpo.do" roles="/Policy/Mis/MedCase/Visit/OpenSpo">
	                            Открытые СПО
	                        </msh:link></li>
						...
						<li><msh:link action="extDisp_journal_user.do" roles="/Policy/Mis/ExtDisp/Card/View">
				...
				<td style='padding-left: 5em'>
					...
					<ul style='list-style: none outside none; '>
						...
						<li><msh:link action="stac_everyday_report.do" roles="/Policy/Mis/MedCase/Stac/Journal/EveryDayReport">
	                            Ежедневный отчет
	                        </msh:link></li>
