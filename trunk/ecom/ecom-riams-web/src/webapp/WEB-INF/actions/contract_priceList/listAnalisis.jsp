...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  %>
    ...
    <msh:form action="/contact_analisis_priceServices_and_medService.do" defaultField="priceListName" disableFormDataConfirm="true" method="GET">
    <msh:panel>
      <msh:row>
   ...
   function checkFieldUpdate(aField,aValue,aDefaultValue) {
    ...
    function find() {
    	...
    	frm.target='' ;
    	frm.action='contact_analisis_priceServices_and_medService.do' ;
    }
    function print() {
    ...
    if (priceList!=null && !priceList.equals("") && !priceList.equals("0"))  {
    	...
    	if (typeFindMed!=null && typeFindMed.equals("1")) {
    		...
    		request.setAttribute("findMedSql", " (pp.code!=ms.code and trim(upper(ms.name))!=trim(upper(pp.name)) or ms.id is null)") ;
    		//request.setAttribute("findMedAddSql", " and ms.id is not null") ;
...
,ms.code as mscode,ms.name as msname
...
where pp.priceList_id = '2' and pp.dtype='PricePosition' ${viewSql} ${findMedAddSql}
order by pp.code
     ...
     action="entityParentView-contract_pricePosition.do" idField="1" >
     	<msh:tableNotEmpty>
     		...
     		<tr>
     			...
     			<th></th>
     			<th></th>
     			<th colspan="2">По прейскуранту</th>
