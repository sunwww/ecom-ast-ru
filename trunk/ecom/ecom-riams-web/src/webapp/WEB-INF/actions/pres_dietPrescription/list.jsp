...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail beginForm="pres_prescriptListForm" mainMenu="Patient" title="Диета" guid="610fe86e-69f6-4ad0-a1dd-146453" />
  </tiles:put>
  <tiles:put name="side" type="string">
    <msh:sideMenu guid="Добавить">
      <msh:sideLink params="id" roles="/Policy/Mis/Prescription/DietPrescription/Create" key="ALT+N" action="/entityParentPrepareCreate-pres_dietPrescription" name="Назначение диеты" />
    </msh:sideMenu>
  ...
  <tiles:put name="body" type="string">
    <msh:table name="list" action="entityParentView-pres_dietPrescription.do" idField="id" guid="bhf1-1e0b-4ebd-9f58-b753b4">
