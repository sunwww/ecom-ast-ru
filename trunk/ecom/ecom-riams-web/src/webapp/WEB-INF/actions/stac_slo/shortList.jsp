...
<tiles:insert page="/WEB-INF/tiles/mainShortLayout.jsp" flush="true" >
  ...
  <tiles:put name="body" type="string">
          ...
          ,MedCase.dischargeTime  as dischargeTime
           ...
           " />
           <msh:section title="Случаи лечения в отделении по госпитализации" 
           createRoles="/Policy/Mis/MedCase/Stac/Ssl/Slo/Create" createUrl="entityParentPrepareCreate-stac_slo.do?id=${param.id}">
  ...
  <tiles:put name="side" type="string">
    <msh:sideMenu title="Добавить" guid="b33faf64-b72e-4845-bf32-5fda8e274fc3">
      <msh:sideLink params="id" action="/entityParentPrepareCreate-stac_slo" 
      roles="/Policy/Mis/MedCase/Stac/Ssl/Slo/Create"
      name="Новый СЛО" key="ALT+2" 
      title="Добавить случай стационарного лечения в отделении" guid="dc488234-9da8-4290-9e71-3b4558d27ec7" />
    </msh:sideMenu>
