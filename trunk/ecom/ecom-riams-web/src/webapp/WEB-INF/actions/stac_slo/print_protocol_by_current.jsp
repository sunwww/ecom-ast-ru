...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name='side' type='string'>
        <msh:sideMenu>
            <msh:sideLink key="ALT+2" styleId="${param.stAll}" action="/stac_print_protocol.do?department=${param.department}&curator=${param.curator}&owner=${param.owner}&stAll=selected" name="Полный список" />
            <msh:sideLink key="ALT+3" styleId="${param.stNoPrint}" action="/stac_print_protocol.do?department=${param.department}&curator=${param.curator}&owner=${param.owner}&stNoPrint=selected" name="Список нераспечатанных протоколов"/>
            <msh:sideLink key="ALT+4" styleId="${param.stPrint}" action="/stac_print_protocol.do?department=${param.department}&curator=${param.curator}&owner=${param.owner}&stPrint=selected" name="Список распечатанных протоколов"/>
        </msh:sideMenu>
    </tiles:put>
