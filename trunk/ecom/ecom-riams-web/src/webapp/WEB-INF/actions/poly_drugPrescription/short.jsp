...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
  ...
  <tiles:put name="body" type="string">
    <!-- 
    	  ...
    	  -->
    <msh:form guid="formHello" action="/entityParentSaveGoView-poly_drugPrescription.do" defaultField="id" title="Назначение лекарственного средства">
      ...
      <msh:panel guid="panel" colsWidth="3">
        ...
        <msh:row guid="32v6eb-b971-441e-9a90-5194a8019c07">
          <msh:textField property="orderTime" label="Время приема (в минутах)" guid="3a3e-8802-467d-b205-715f"  />
        ...
        <msh:row guid="b55h6geb-b971-441e-9a90-5194a8019c07">
          <msh:textField label="Количество на один прием" property="amount" guid="3a3d8-467d-b205-715fb379b018" />
