...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="side" type="string">
    <msh:sideMenu guid="helloSideMenu-123">
      <msh:sideLink guid="helloSideLinkNew" roles="/Policy/IdeMode/Hello/Create" key="ALT+N" action="/entityPrepareCreate-mis_workerNew" name="Создать новое" />
    </msh:sideMenu>
  </tiles:put>
  <tiles:put name="body" type="string">
    <msh:table name="list" action="entityView-mis_workerNew.do" idField="id" guid="b621e361-1e0b-4ebd-9f58-b7d919b45bd6">
      ...
      <msh:tableColumn columnName="hello" identificator="false" property="hello" guid="3a04626c-6a0c-47bc-bae9-7e058925b67a" />
    </msh:table>
  </tiles:put>
</tiles:insert>
