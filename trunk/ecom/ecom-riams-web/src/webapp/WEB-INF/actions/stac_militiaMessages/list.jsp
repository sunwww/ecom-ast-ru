...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="body" type="string">
    <msh:ifInRole roles="/Policy/Mis/MedCase/Stac/Ssl/MilitiaMessages/View" guid="2ccd6a7e-21cc-45b9-8e22-6f0b911309b1">
      <ecom:webQuery name="listMil" nativeSql="select id, number, phoneDate, phoneTime,phone,recieverOrganization from PhoneMessage &#xA;where phoneMessageType_id=2 and medCase_id=${param.id} " guid="22c22466-c40e-4e93-8f1f-8c53d1a96f30" />
      <msh:table name="listMil" action="entityView-stac_militiaMessages.do" idField="1" guid="d579127c-69a0-4eca-b3e3-950381d1585c">
  ...
  <tiles:put name="side" type="string">
    <msh:sideMenu title="Добавить" guid="6372e109-9e1b-49dc-840b-9b38f524efeb">
      <msh:sideLink params="id" action="/entityParentPrepareCreate-stac_militiaMessages" name="Сообщение" title="Добавить сообщение в милиция" guid="436bbb7b-497c-4b10-ba0e-c5601675a713" roles="/Policy/Mis/MedCase/Stac/Ssl/MilitiaMessages/Create" />
    </msh:sideMenu>
  </tiles:put>
</tiles:insert>
