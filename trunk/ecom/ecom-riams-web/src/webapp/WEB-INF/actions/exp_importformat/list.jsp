<%-- ikouzmin 070308 +++ Список форматов импорта --%>
...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
    ...
    <tiles:put name='side' type='string'>
        <msh:sideMenu>
            ...
            <msh:sideLink key='ALT+N' params="id" action="/entityParentPrepareCreate-exp_importformat" name="Создать новый формат" />

        </msh:sideMenu>
    </tiles:put>

    <tiles:put name='body' type='string' >
        <msh:table name="list" action="entityParentEdit-exp_importformat.do" idField="id">
