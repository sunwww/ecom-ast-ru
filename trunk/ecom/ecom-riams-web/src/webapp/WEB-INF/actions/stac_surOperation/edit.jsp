...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
  ...
  <tiles:put name="body" type="string">
    <!-- 
    	  ...
    	  -->
    <msh:form action="/entityParentSaveGoView-stac_surOperation.do" defaultField="numberInJournal" guid="137f576d-2283-4edd-9978-74290e04b873" editRoles="/Policy/Mis/MedCase/Stac/Ssl/SurOper/Edit" createRoles="/Policy/Mis/MedCase/Stac/Ssl/SurOper/Create">
      <msh:panel guid="80209fa0-fbd4-45d0-be90-26ca4219af2e" colsWidth="15px,250px,15px">
        ...
        <msh:row guid="1221-2e6b-425a-a14e-1c02959">
          <msh:autoComplete property="operation" label="Операция" guid="e22-9d6f-4c39-a6a1-302f14f" fieldColSpan="3" horizontalFill="true" vocName="vocOperation" />
        </msh:row>
        <msh:row guid="1221-2e6b-425a-a14e-1c02959">
        ...
        <msh:row>
        	<msh:autoComplete label="Хирург" property="surgeon" horizontalFill="true" fieldColSpan="3" vocName="workFunction"/>
        </msh:row>
