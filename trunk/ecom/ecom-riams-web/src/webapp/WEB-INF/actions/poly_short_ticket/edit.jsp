...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
  ...
  <tiles:put name="body" type="string">
    <msh:form action="entitySaveGoView-poly_short_ticket.do" defaultField="date" guid="77bf3d00-cfc6-49eb-9751-76e82d38751c">
      ...
      <msh:panel colsWidth="15%,15%,15%,55%" guid="fecf8cd8-e883-4375-b47a-2954067ec3a7">
        <msh:row guid="59560d9f-0765-4df0-bfb7-9a90b5eed824">
          <msh:textField label="Дата приема" property="date" fieldColSpan="1" guid="9e3a8e0d-cd82-4158-b764-e15cb16b4fca" />
        </msh:row>
        <msh:row guid="47073a0b-da87-49e0-9ff0-711dc597ce07">
          <msh:autoComplete parentId="poly_short_ticketForm.medcard" vocName="workFunctionByTicket" property="workFunction" label="Специалист" fieldColSpan="3" size="100" horizontalFill="true" guid="a8404201-1bae-467e-b3e9-5cef63411d01" />
        </msh:row>
        <msh:row>
  ...
  <tiles:put name="side" type="string">
    <msh:ifFormTypeIsView formName="poly_short_ticketForm" guid="8f-4d80-856b-ce3095ca1d">
      <msh:sideMenu guid="e6c81315-888f-4d80-856b-ce3095ca1d55" title="Талон">
        <msh:sideLink roles="/Policy/Poly/ShortTicket/Edit" key="ALT+3" params="id" action="/entityParentEdit-poly_short_ticket" name="Изменить" guid="89585df8-aadb-4d59-abd9-c0d16a6170a9" title="Изменить талон" />
        <msh:ifFormTypeAreViewOrEdit formName="poly_short_ticketForm" guid="7f581b0a-a8b3-4d57-9cff-6dc6db1c85e3">
          <msh:sideLink roles="/Policy/Poly/ShortTicket/Delete" key="ALT+DEL" params="id" action="/entityParentDeleteGoParentView-poly_short_ticket" name="Удалить" confirm="Вы действительно хотите удалить талон?" guid="8b9de89f-3b99-414e-b4af-778ccbb70edf" title="Удалить талон" />
        </msh:ifFormTypeAreViewOrEdit>
      </msh:sideMenu>
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail mainMenu="Medcard" beginForm="poly_short_ticketForm" guid="5c4f3682-e66b-4e0d-b448-4e6a2961a943" />
  </tiles:put>
</tiles:insert>
