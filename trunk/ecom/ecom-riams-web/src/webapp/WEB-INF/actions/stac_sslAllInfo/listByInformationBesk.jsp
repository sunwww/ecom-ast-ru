  ...
  <tiles:put name="body" type="string">    
	    ...
	    <msh:panel guid="6ae283c8-7035-450a-8eb4-6f0f7da8a8ff"  colsWidth="10%,89%">
	      <msh:row guid="53627d05-8914-48a0-b2ec-792eba5b07d9" >
	        <msh:separator label="Параметры поиска" colSpan="6" guid="15c6c628-8aab-4c82-b3d8-ac77b7b3f700" />
		      ...
		      <msh:row>
		      	<msh:textField property="lastname"  label="Фамилия Имя Отчество" size="100"/>
		      </msh:row>
		      <msh:row>
		           <td align="left">
        ...
        <%
		    ...
		    if (lastname!=null && !lastname.equals("") )  {
		    	...
		    	if (s.length>=2) {
		    		request.setAttribute("firtsname","and pat.firstname like '"+s[1]+"%'") ;
		    	} else {
		    		request.setAttribute("firtsname","") ;
		    	}
		    	if (s.length>=3) {
    	...
    	%>
    <msh:section>
    <msh:sectionTitle>Журнал состоящих пациентов для стола справок </msh:sectionTitle>
    <msh:sectionContent>
