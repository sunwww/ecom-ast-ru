...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
  ...
  <tiles:put name="side" type="string">
    <msh:ifFormTypeIsView formName="preg_obstetricNewBornForm" guid="c8ee4cc0-2ebd-4772-8d66-f2891f3c6f04">
      <msh:sideMenu title="Новорожденный" guid="bef784df-2afa-4cbb-8052-3b0ea730b81c">
        <msh:sideLink key="ALT+2" params="id" action="/entityEdit-preg_obstetricNewBorn" name="Изменить" roles="/Policy/Mis/NewBorn/Edit" guid="920412b7-c092-4ef5-bec9-d0e235b8f8c4" />
        <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id" action="/entityParentDeleteGoParentView-preg_obstetricNewBorn" name="Удалить" roles="/Policy/Mis/NewBorn/Delete" guid="dc3b73ce-bf8d-4651-baf0-718b8779e8da" />
      </msh:sideMenu>
  ...
  <tiles:put name="body" type="string">
    <!-- 
    	  - Новорожденный
    	  -->
    <msh:form action="/entityParentSaveGoView-preg_obstetricNewBorn.do" defaultField="lastname" guid="88a846fc-510d-4ffd-b68a-f4157d2ccdba">
      ...
      <msh:panel guid="6698b1a2-f6ce-4e70-85a3-0c3689e690da" colsWidth="7%,7%,4%">
        ...
        <msh:ifFormTypeIsView formName="preg_obstetricNewBornForm" guid="2211c6d9-2251-4059-b91c-780e6bf32bad">
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail mainMenu="Patient" beginForm="preg_obstetricNewBornForm" guid="59d4465e-092d-4353-98ff-af27d0a2c482" />
  </tiles:put>
</tiles:insert>
