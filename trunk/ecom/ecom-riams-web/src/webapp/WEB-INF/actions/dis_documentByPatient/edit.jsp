  ...
  <script type="text/javascript">
    ...
    <msh:form guid="formHello" action="/entityParentSaveGoView-dis_documentByPatient.do" defaultField="documentTypeName">
      ...
      <msh:panel>
        ...
        <msh:row>
          <msh:autoComplete showId="false" vocName="workFunction" hideLabel="false" property="workFunctionAdd" viewOnlyField="false" label="Специалист" fieldColSpan="3" horizontalFill="true" />
        </msh:row>
