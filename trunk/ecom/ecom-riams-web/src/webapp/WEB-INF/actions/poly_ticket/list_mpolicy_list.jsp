...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
    ...
    <tiles:put name='side' type='string'>
        <tags:ticket_finds currentAction="ticketsByProblemWithMpolicy"/>
    </tiles:put>
  ...
  <tiles:put name="body" type="string">
    ...
    <msh:sectionContent>
    <ecom:webQuery name="journal_ticket" nativeSql="select p.id,t.date
	,$$CheckPatientOMC^ZMedPolicy(m.person_id,t.date)
	,p.lastname||' '||p.firstname||' '||p.middlename,count(*) as count,m.number 
	,list(distinct vss.name) as vssname
	from Ticket t 
	...
	and $$CheckPatientOMC^ZMedPolicy(m.person_id,t.date) is not null group by m.id" guid="4a720225-8d94-4b47-bef3-4dbbe79eec74" />
        <msh:table name="journal_ticket" action="entityView-mis_patient.do" idField="1" noDataMessage="Не найдено">
            ...
            <msh:tableColumn columnName="Вид оплаты" property="7"/>
        </msh:table>
    </msh:sectionContent>
    ...
    function find() {
    	...
    	frm.target='' ;
    	frm.action='poly_problemTickets_list.do' ;
    }
    function print() {
    	var frm = document.forms[0] ;
    	frm.target='_blank' ;
