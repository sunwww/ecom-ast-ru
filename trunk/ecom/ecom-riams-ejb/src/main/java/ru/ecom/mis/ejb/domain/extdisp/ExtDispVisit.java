...
public class ExtDispVisit extends ExtDispService{
	...
	public List<ExtDispDiagnosis> getDiagnosis() {
		return theDiagnosis;
	}
	public void setDiagnosis(List<ExtDispDiagnosis> aDiagnosis) {
	...
	@OneToMany(mappedBy="visit", cascade=CascadeType.ALL)
	public List<ExtDispServiceIndication> getServiceIndications() {
		return theServiceIndications;
	}
	public void setServiceIndications(List<ExtDispServiceIndication> aServiceIndications) {
		theServiceIndications = aServiceIndications;
	}
	/**
