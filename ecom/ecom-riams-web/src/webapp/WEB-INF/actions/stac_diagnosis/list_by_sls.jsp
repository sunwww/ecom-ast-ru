...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  %>
    <msh:form action="/stac_diagnosis_by_sls_list.do" defaultField="department" disableFormDataConfirm="true" method="GET" guid="d7b31bc2-38f0-42cc-8d6d-19395273168f">
...
+case when (cast(to_char(${fldDate}, 'mm') as int)-cast(to_char(pat.birthday, 'mm') as int)) <0 then -1 when (cast(to_char(${fldDate},'dd') as int) - cast(to_char(pat.birthday,'dd') as int)<0) and ((cast(to_char(${fldDate}, 'mm') as int)-cast(to_char(pat.birthday, 'mm') as int)-1)<0)  then -1 else 0 end
    ...
    <msh:table name="datelist" action="entityParentView-stac_sls.do" idField="1" >
      ...
      <msh:tableColumn columnName="Адрес" property="9" role="/Policy/Mis/Journal/ViewInfoPatient" guid="d9642df9-5653-4920-bb78-1622cbeefa34" />
      <msh:tableColumn columnName="Дата рождения" property="5" guid="34a9f56a-2b47-4feb-a3fa-5c1afdf6c41d" />
      <msh:tableColumn columnName="Возраст" property="10" guid="34a9f56a-2b47-4feb-a3fa-5c1afdf6c41d" />
