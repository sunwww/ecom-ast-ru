...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  %>
    <msh:form action="/stac_diagnosis_hospital.do" defaultField="department" disableFormDataConfirm="true" method="GET" guid="d7b31bc2-38f0-42cc-8d6d-19395273168f">
  ...
  <ecom:webQuery name="diag_priority_m_sql" nativeSql="select id,name from VocPriorityDiagnosis where code='1'"/>
    	...
    	if (filter!=null && !filter.equals("")) {
    		...
    		filtOr.insert(0, " and (").append(")") ;
    		filtOr.append(" and vdrt").append(addD1).append(".id='").append(request.getAttribute("diag_typeReg_disch")).append("' and vpd").append(addD1).append(".id='").append(request.getAttribute("diag_priority_m")).append("'") ;
    		request.setAttribute("filter"+addD+"Sql", filtOr.toString()) ;
    	}
