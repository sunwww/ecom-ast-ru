  ...
  <tiles:put name="body" type="string">
    <msh:section guid="863b6d75-fded-49ba-8eab-108bec8e092a">
      ...
      <msh:sectionContent guid="ab8e5a72-aadd-4c65-8691-2205506e63dc">
        <ecom:webQuery name="listInf" guid="909fd277-28b6-4ce3-841c-7d76ee74c9e0" nativeSql="select smc.id,smc.dateExecute,smc.timeExecute,pat.lastname || ' ' || pat.firstname || ' ' || pat.middlename,pat.birthday from MedCase as smc left join Patient pat on smc.patient_id=pat.id left join MedService ms on smc.medService_id=ms.id where smc.dateExecute='${param.id}' " />
