...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="body" type="string">
    ...
    select m.${dateSearch} ,
(select count(*) from MedCase m1 where m1.DTYPE='HospitalMedCase' and m1.${dateSearch}=m.${dateSearch} and (m1.noActuality is null or cast(m1.noActuality as integer)=0) and (m1.emergency is null or cast(m1.emergency as integer)=0) and m1.deniedHospitalizating_id is null) as pl
,
...
group by m.${dateSearch}
    ...
    <msh:table name="journal_priem" action="js-stac_sslAllInfo-findByDate.do?dateSearch=${dateSearch}" idField="1" guid="b621e361-1e0b-4ebd-9f58-b7d919b45bd6">
      ...
      <msh:tableColumn columnName="Итого" identificator="false" property="4" guid="7f973955-a5cb-4497-bd0b-f4d05848f049" />
      <msh:tableColumn columnName="Отказ" property="5" guid="f34e1b12-3392-4978-b31f-5e54ff2e45bd" />
