...
,count(case when sls.result_id!=6 then sls.id else null end) as cntNoDeath
,count(case when sls.result_id!=6 and sls.emergency='1' then sls.id else null end) as cntNoDeathEmer
,count(case when sls.result_id!=6 and sls.emergency='1' and sls.orderType_id='3' then sls.id else null end) as cntNoDeathEmerSk
,sum(case when sls.result_id!=6 then
case 
...
,count(case when sls.result_id=6 then sls.id else null end) as cntDeath
