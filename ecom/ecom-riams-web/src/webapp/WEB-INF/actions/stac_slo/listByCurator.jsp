...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="body" type="string">    
      <msh:ifInRole roles="/Policy/Mis/MedCase/Stac/Journal/ShowInfoAllDepartments">
		    <msh:form action="/stac_journalByCurator.do" defaultField="department" disableFormDataConfirm="true" method="POST" guid="d7b31bc2-38f0-42cc-8d6d-19395273168f">
		    <msh:panel guid="6ae283c8-7035-450a-8eb4-6f0f7da8a8ff"  colsWidth="10%,89%">
		      <msh:row guid="53627d05-8914-48a0-b2ec-792eba5b07d9" >
		        <msh:separator label="Параметры поиска" colSpan="6" guid="15c6c628-8aab-4c82-b3d8-ac77b7b3f700" />
			      ...
			      <msh:row>
			      	<msh:autoComplete property="department" vocName="workFunction" label="Лечащий врач" fieldColSpan="4" horizontalFill="true"/>
		           <td>
    	...
    	%>
    <msh:section>
    <msh:sectionTitle>Журнал по лечащему врачу:  ${curatorInfo}</msh:sectionTitle>
    <msh:sectionContent>
    <ecom:webQuery name="datelist" nativeSql="select m.id,m.dateStart,pat.lastname ||' ' ||pat.firstname|| ' ' || pat.middlename,pat.birthday,sc.code  from medCase m left join MedCase as sls on sls.id = m.parent_id left join StatisticStub as sc on sc.medCase_id=sls.id left outer join Patient pat on m.patient_id = pat.id where m.DTYPE='DepartmentMedCase' and m.ownerFunction_id='${curator}' and m.transferDate is null and m.dateFinish is null" guid="81cbfcaf-6737-4785-bac0-6691c6e6b501" />
