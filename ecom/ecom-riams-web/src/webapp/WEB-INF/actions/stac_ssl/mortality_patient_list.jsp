...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true" >
  ...
  <tiles:put name="body" type="string">
   ...
   " guid="4a720225-8d94-4b47-bef3-4dbbe79eec74" />
    ...
    %>
    <msh:section title="Реестр пациентов по отделению">
    <msh:sectionContent>
...
left join vochospitalizationresult vhr on vhr.id=hmc.result_id
	...
	left join mislpu d on d.id=dmc.department_id
	left join mislpu pd on pd.id=pdmc.department_id
where hmc.dtype='HospitalMedCase' and ${dateT} between to_date('${param.dateBegin}','dd.MM.yyyy') and to_date('${dateEnd}','dd.MM.yyyy') and hmc.datefinish is not null and hmc.dischargetime is not null 
