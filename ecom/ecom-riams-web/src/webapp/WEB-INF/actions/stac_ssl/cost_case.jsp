...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  ,to_char(coalesce(m.datestart,current_date),'dd.mm.yyyy') as dfinish from medcase m where m.id=${param.id}
  "/>
  <%
...
left join medservice ms on ms.id=wfs.medservice_id
	left join pricemedservice pms on pms.id=wfs.medservice_id
...
and pp.priceList_id='${priceList}'
  ...
  <msh:sectionContent>
	...
	left join pricemedservice pms on pms.id=smc.medservice_id
	left join priceposition pp on pp.id=pms.priceposition_id
  ...
  <msh:sectionContent>
	...
	left join pricemedservice pms on pms.id=so.medservice_id
	left join priceposition pp on pp.id=pms.priceposition_id
  	where 
