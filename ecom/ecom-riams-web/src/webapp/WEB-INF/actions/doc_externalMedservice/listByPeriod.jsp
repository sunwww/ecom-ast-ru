...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true" >
  ...
  %>
    <msh:form action="/journal_doc_externalMedService.do" defaultField="dateBegin" disableFormDataConfirm="true" method="GET" guid="d7b31bc2-38f0-42cc-8d6d-19395273168f">
...
${having} order by orderlpu " />
    ...
    viewUrl="journal_doc_externalMedService.do?short=Short&typeList=${typeList}&noViewForm=1&period=${dateBegin}-${dateEnd}" 
     action="journal_doc_externalMedService.do?noViewForm=1&typeList=${typeList}&period=${dateBegin}-${dateEnd}" idField="1" guid="b621e361-1e0b-4ebd-9f58-b7d919b45bd6">
...
order by orderer " />
    ...
    viewUrl="journal_doc_externalMedService.do?short=Short&typeList=${typeList}&noViewForm=1&period=${param.period}&lpuid=${param.id}" 
     action="journal_doc_externalMedService.do?noViewForm=1&typeList=${typeList}&period=${param.period}&lpuid=${param.id}" idField="1" guid="b621e361-1e0b-4ebd-9f58-b7d919b45bd6">
