...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
  ...
  <tiles:put name="title" type="string">
    <msh:title mainMenu="Medcard" guid="4b11dc98-30fc-413e-8bc6-976f292e704f">Список дублей талонов</msh:title>
  </tiles:put>
  ...
  <tiles:put name="body" type="string">
    ...
    <msh:table name="list" action="entityParentView-poly_ticket.do" idField="1" noDataMessage="Не найдено" guid="6600cebc-4548-4f57-a048-5a3a2e67a673">
