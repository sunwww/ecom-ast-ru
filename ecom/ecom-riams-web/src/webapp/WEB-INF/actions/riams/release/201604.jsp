		...
		<table class='mainMenu'>
			<tr>
				...
				<li>Запрет на набитие диспансеризации для пациентов без актуального полиса</li>
					...
					<li>Добавлена возможность массового удаление открытых талонов: по мед. карте (в самой амб. карте), всех талонов до определенной даты (в настройках)</li>
					<li>Создан журнал по экспертным картам</li>
					<li></li>
				</ul>
