		...
		<table class='mainMenu'>
			<tr>
				...
				<ul>
					...
					<li>Доработано ограничение на основные диагнозы в отделениям</li>
					...
					<li>Добавлено оповещение всех пользователей об обновление</li>
