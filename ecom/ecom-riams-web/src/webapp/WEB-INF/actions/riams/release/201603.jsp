	...
	<tiles:put name='body' type='string'>
		<table class='mainMenu'>
			<tr>
				...
				<h2>Изменения от 31.03.2016</h2>
				<ul>
					<li>Доработана автоматическая генерация, с возможностью просмотра раб. функций, у которых установлена автогенерация</li>
					<li>Доработан запрет на ввод операций. (настройка в подразделение) </li>
					<li>Доработана генерация талонов по экстренным пунктам из отказов от госпитализаций (отчеты-отказы от госпитализаций без диагнозов)</li>
					<li>Доработана печать 007 формы по стационару</li>
					<li></li>
				</ul>
				...
				<ul>
					...
					<li>Исправлена ошибка при удаление направления на госпитализацию</li>
				</ul>
