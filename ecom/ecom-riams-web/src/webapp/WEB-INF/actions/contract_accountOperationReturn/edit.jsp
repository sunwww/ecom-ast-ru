...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
	<tiles:put name="body" type="string">
		<msh:form action="/entityParentSaveGoParentView-contract_accountOperationReturn.do" defaultField="discount">
			...
			<msh:panel colsWidth="10%,10%,10%,10%">
				<msh:row>
					...
					<td align="left" ">
						<msh:ifFormTypeIsCreate formName="contract_accountOperationReturnForm">
				...
				<msh:ifInRole roles="/Policy/Mis/Contract/MedContract/ServedPerson/ContractAccount/ContractAccountOperation/EditOperationInfo">
					<msh:ifFormTypeIsNotView formName="contract_accountOperationReturnForm">
						<msh:row>
				...
				<msh:ifFormTypeIsView formName="contract_accountOperationReturnForm">
				<msh:row>
					<msh:textField property="operationDate" label="Дата операции"/>
					<msh:textField property="operationTime" label="Время"/>
				</msh:row>
...
select cams.id, pp.code,pp.name,cams.cost,cams.countMedService 
	...
	, cao.discount,round(cams.countMedService*(cams.cost*(100-coalesce(cao.discount,0))/100),2)
			...
			left join ContractAccountOperation cao on cao.id=caos.accountOperation_id and cao.dtype='OperationReturn'
			...
			"/>
				...
				action="entityParentView-contract_accountMedService.do"
				 ...
				 idField="1">
					...
					<msh:tableColumn columnName="Итог" isCalcAmount="true" property="8" />
	...
	<tiles:put name="title" type="string">
		<ecom:titleTrail mainMenu="Contract" beginForm="contract_accountOperationReturnForm" />
	</tiles:put>
	<tiles:put name="side" type="string">
		<msh:ifFormTypeAreViewOrEdit formName="contract_accountOperationReturnForm">
			<msh:sideMenu>
				...
				<msh:sideLink key="ALT+DEL" confirm="Вы точно хотите удалить возврат?" params="id" action="/entityParentDeleteGoParentView-contract_accountOperation" name="Удалить" title="Удалить" roles="/Policy/Mis/Contract/MedContract/ServedPerson/ContractAccount/ContractAccountOperation/Delete"/>
			</msh:sideMenu>
