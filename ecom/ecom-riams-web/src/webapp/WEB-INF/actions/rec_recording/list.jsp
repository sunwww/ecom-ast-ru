...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="side" type="string">
    <msh:sideMenu guid="helloSideMenu-123">
      <msh:sideLink guid="helloSideLinkNew" roles="/Policy/IdeMode/Hello/Create" key="ALT+N" action="/entityPrepareCreate-rec_recording" name="Создать новое" />
    </msh:sideMenu>
  </tiles:put>
  <tiles:put name="body" type="string">
    <msh:table name="list" action="entityView-rec_recording.do" idField="id" guid="b621e361-1e0b-4ebd-9f58-b7d919b45bd6">
