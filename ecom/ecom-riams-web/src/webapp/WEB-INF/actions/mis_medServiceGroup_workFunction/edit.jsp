...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
  ...
  <tiles:put name="side" type="string">
    <tags:style_currentMenu currentAction="mis_medServiceGroup_workFunction" />
    <msh:sideMenu title="Прикрепление раб.функции">
      <msh:ifFormTypeIsView formName="mis_medServiceGroup_workFunctionForm">
        <msh:sideLink key="ALT+1" params="id" action="/entityParentEdit-mis_medServiceGroup_workFunction" name="Изменить" roles="/Policy/Mis/MedService/VocWorkFunction/Edit" />
      </msh:ifFormTypeIsView>
      <msh:ifFormTypeAreViewOrEdit formName="mis_medServiceGroup_workFunctionForm" >
        <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id" action="/entityParentDeleteGoParentView-mis_medServiceGroup_workFunction" name="Удалить" roles="/Policy/Mis/MedService/VocWorkFunction/Delete"/>
  ...
  <tiles:put name="body" type="string">
    <!-- 
    	  - Медицинских услуг
    	  -->
    <msh:form action="/entityParentSaveGoParentView-mis_medServiceGroup_workFunction.do" defaultField="vocMedService" >
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail mainMenu="Voc" beginForm="mis_medServiceGroup_workFunctionForm"/>
  </tiles:put>
</tiles:insert>
