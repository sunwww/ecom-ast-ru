...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
  ...
  <tiles:put name="side" type="string">
    ...
    <msh:ifFormTypeAreViewOrEdit formName="diary_userDomainForm" guid="8db06246-c49c-496a-bb1f-2de391e40631">
      <msh:sideMenu title="Добавить" guid="adding">
        <msh:sideLink action="/entityParentPrepareCreate-diary_userValue" name="Значение" params="id" roles="/Policy/Diary/User/Domain/Value/Create" guid="a05cafca-1220-455a-b608-b00ed338fdc3" />
      </msh:sideMenu>
  ...
  <tiles:put name="body" type="string">
    <!-- 
    	  - Медицинских услуг
    	  -->
    <msh:form action="/entityParentSaveGoView-diary_userDomain.do" defaultField="name" guid="be2c889f-ed1d-4a2b-9cda-9127e9d94885">
      ...
      <msh:panel guid="d1cd0310-bf53-4ce1-9dd5-06388b51ec01" colsWidth="20% 30%">
        <msh:row guid="bb6f7393-5e65-498c-8279-b849d7e9f6b4">
          <msh:textField property="name" label="Наименование" size="50" guid="b87e9cee-cf5d-43bc-b50d-1911d5e87e40" horizontalFill="true" />
        </msh:row>
    ...
    <msh:ifInRole roles="/Policy/Mis/MedService/View" guid="5e3d7e52-5747-4b60-aab3-f99027a64117">
      <msh:ifFormTypeIsView formName="diary_userDomainForm" guid="9f1dd6a4-a7b7-43e7-b205-85730bba6968">
        <msh:section title="Значения" guid="e681be03-dea7-4bce-96cf-aa600185f156">
