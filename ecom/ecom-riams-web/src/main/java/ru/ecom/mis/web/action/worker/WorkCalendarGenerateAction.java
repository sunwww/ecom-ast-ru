...
public class WorkCalendarGenerateAction extends BaseAction {
    public ActionForward myExecute(ActionMapping aMapping, ActionForm aForm, HttpServletRequest aRequest, HttpServletResponse aResponse) throws Exception {
        ...
        serviceDo(service,lpuId, JaasUtil.convertToLongs(aRequest.getParameterValues("id")),beginDate,finishDate);
        return new ActionForward(aMapping.findForward("success").getPath()+"?id="+lpuId, true) ;
    }

    void serviceDo(IWorkCalendarService aService, long aLpuId, long[] aFunctions,Date aBeginDate,Date aFinishDate) {
