...
public class ServiceAfterUpdateAction extends BaseAction {
    public ActionForward myExecute(ActionMapping aMapping, ActionForm aForm, HttpServletRequest aRequest, HttpServletResponse aResponse) throws Exception {
        ...
        if (aRequest.getParameter("emergency")!=null) {
        	service.executeUpdateNativeSql("insert into CustomMessage (isemergency,Recipient,MessageTitle,MessageText,Username,MessageUrl,DispatchDate,DispatchTime,issystem)" 
