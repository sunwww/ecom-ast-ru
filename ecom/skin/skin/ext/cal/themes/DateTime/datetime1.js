...
var gcCalFrame="#e8f0f4";	// the background color of the inner table, showing as a frame.
...
var gsOuterTable=NN4?"border=1 cellpadding=5 cellspacing=0":"border=0 cellpadding=0 cellspacing=1";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var giCellWidth=NN4?25:24;	// calendar cell width;
...
var gcCellBG="#d8e0e4";	// default background color of the cells. Use "" for transparent!!!
...
var gcBGToday="#D4D0C8";	// the background color for today 
...
var gcBGSelected="black";	// the background color for the selected date
