...
public class ConvertSql {
    ...
    public static boolean parseBoolean(Object aValue) {
        return aValue != null && parseString(aValue).equals("1");
    }
    ...
    public static String getMonth(java.sql.Date aDate, boolean aFullname, boolean aTitleMonth) {
        ...
        if (Calendar.FEBRUARY == cal.get(Calendar.MONTH))
            return aFullname ? (aTitleMonth ? "Февраль" : "февраля") : "02";
        ...
        if (Calendar.SEPTEMBER == cal.get(Calendar.MONTH))
            return aFullname ? (aTitleMonth ? "Сентябрь" : "сентября") : "09";
        if (Calendar.OCTOBER == cal.get(Calendar.MONTH))
            return aFullname ? (aTitleMonth ? "Октябрь" : "октября") : "10";
        ...
        if (Calendar.DECEMBER == cal.get(Calendar.MONTH))
            return aFullname ? (aTitleMonth ? "Декабрь" : "декабря") : "12";
        return "";
    }
