...
public class ContractServiceBean implements IContractService {
	...
	public String makeKKMPaymentOrRefund(Long aAccountId,String aDiscont, Boolean isRefund,Boolean isTerminalPayment, String aKassir, EntityManager aManager, String url) {
		try {
			...
			//	log.warn("isTermPayment = "+isTerminalPayment);
				makeHttpPostRequest(root.toString(), aManager, url);
	...
	private void makeHttpPostRequest(String data, EntityManager aManager, String address) throws IOException {
	...
	public String sendKKMRequest(String aFunction, Long aAccountId, String aDiscont, Boolean isTerminalPayment, String aKassir,EntityManager aManager, String url)  {
			if (aFunction!=null &&aFunction.equals("makePayment")) {
				return makeKKMPaymentOrRefund(aAccountId, aDiscont, false, isTerminalPayment,aKassir,aManager,url);
			} else if (aFunction!=null&&aFunction.equals("makeRefund")) {
				return makeKKMPaymentOrRefund(aAccountId, aDiscont, true, isTerminalPayment,aKassir, aManager,url);
