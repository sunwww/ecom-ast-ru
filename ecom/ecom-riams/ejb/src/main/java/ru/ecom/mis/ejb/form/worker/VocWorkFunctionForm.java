...
public class VocWorkFunctionForm extends IdEntityForm {
    ...
    @Persist
    public Boolean getIsSuitForCovid() {
        return isSuitForCovid;
    }
     ...
     */
    @Comment("Не может быть лечащим врачом")
    @Persist
    public Boolean getIsNotSuitForTreatDoctor() {
        return isNotSuitForTreatDoctor;
    }
