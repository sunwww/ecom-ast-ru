...
@Comment("Диагноз")
@WebTrail(comment = "Диагноз"
	, nameProperties= "diagnosisInfo"
		, view="entityView-stac_diagnosis.do"
			,list = "entityParentList-stac_diagnosis.do")
...
public class DiagnosisForm extends IdEntityForm {
	...
	@Persist
	public Long getBackgroundDisease() {return backgroundDisease;}
	/** Фоновое заболевание */
	private Long backgroundDisease;
