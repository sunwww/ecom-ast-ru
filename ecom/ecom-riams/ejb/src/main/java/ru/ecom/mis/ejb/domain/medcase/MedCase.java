...
abstract public class MedCase extends BaseEntity {
	...
	public List<HitechMedicalCase> getHitechMedicalCases() {return hitechMedicalCases;}
	...
	@ManyToOne
	public MedCase getParent() {return parent;}

	/** Тип СМО*/
	@Comment("Тип СМО")
	@OneToOne
	public VocMedCaseDefect getMedCaseDefect() {return medCaseDefect;}
	...
	@Comment("Опьянение")
	@OneToOne
	public VocIntoxication getIntoxication() {	return intoxication;	}

	/** Хирургические операции */
	@Comment("Хирургические операции")
	@OneToMany(mappedBy="medCase", cascade=CascadeType.ALL, fetch = FetchType.LAZY)
	public List<SurgicalOperation> getSurgicalOperations() {return surgicalOperations;	}
	...
	@OneToOne
	public WorkFunction getStartFunction() {return startFunction;}
	...
	@Comment("Вид ВМП")
	@OneToOne @Deprecated
	public VocKindHighCare getKindHighCare() {return kindHighCare;}

	/** Метод ВМП */
	@Comment("Метод ВМП")
	@OneToOne @Deprecated
	public VocMethodHighCare getMethodHighCare() {return methodHighCare;}
