...
public interface IAddressPointService {
    ...
    public WebQueryResult exportAll(String aAge, String aFilenameAddSuffix, String aAddSql, boolean aLpuCheck, Long aLpu, Long aArea, String aDateFrom, String aDateTo, String aPeriodByReestr, String aNReestr, String aNPackage, Long aCompnay, boolean needDivide, String xmlFormat) throws ParserConfigurationException, TransformerException;
