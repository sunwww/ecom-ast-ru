...
public class AbstractFormServiceBeanHelper implements IFormService {
    ...
    private static Method getIdMethod(Class aEntityClass) throws NoSuchMethodException {
...
//			// если нет данных, то не надо закрывать на просмотр
     ...
     * @param aForm       форма
     * @param aEntity     сущность
     * @param aMustCopyId нужно копировать и
     * @throws InstantiationException
     * @Persion и
    ...
    private void saveOneToManyOneProperty(String aJson, Collection aCollection,
                                          Class aType, String aTableName, String aParentProperty, String aValueProperty, Object aId) throws ParseException,
