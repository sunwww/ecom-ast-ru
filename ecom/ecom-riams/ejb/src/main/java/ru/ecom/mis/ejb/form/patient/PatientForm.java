...
public class PatientForm extends IdEntityForm {
    ...
    public String getMobileAppPhoneNumber() {
        return mobileAppPhoneNumber;
    }
    ...
    @ADynamicSecurityInterceptor(PatientDynamicSecurityInterceptor.class)
    public Long getLpuAreaAddressText() {
        return lpuAreaAddressText;
    }
    ...
    public Long getAttachedOmcPolicy() {
        return attachedPolicyOmc;
    }
    ...
    public MedPolicyOmcForm getPolicyOmcForm() {
        return policyOmcForm;
    }

    /**
     * Создать новый полис ОМС
     */
    public boolean getCreateNewOmcPolicy() {
        return createNewOmcPolicy;
    }
    ...
    public boolean getCreateAttachedByDepartment() {
        return createAttachedByDepartment;
    }
    ...
    @Persist
    public String getRealFlatNumber() {
        return realFlatNumber;
    }
    ...
    public String getRealHouseBuilding() {
        return realHouseBuilding;
    }
    ...
    @Persist
    public String getNonresidentZipcode() {
        return nonresidentZipcode;
    }
    ...
    @Persist
    public String getPassportCodeDivision() {
        return passportCodeDivision;
    }
    ...
    @Persist
    public Boolean getIsCompatriot() {
        return isCompatriot;
    }
    ...
    public LpuAttachedByDepartmentForm getAttachedForm() {
        return attachedForm;
    }
    ...
    public Boolean getCreateNewAttachment() {
        return createNewAttachment;
    }
