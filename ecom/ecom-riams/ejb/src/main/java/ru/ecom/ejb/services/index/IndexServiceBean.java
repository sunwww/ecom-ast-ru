...
public class IndexServiceBean implements IIndexService, IIndexServiceManagement {
    ...
    public IndexServiceBean() throws NamingException, SQLException,
        ...
        if (needToUpdateSchema()) {
			...
			LOG.warn("Jboss is running without 'hibernate.hbm2ddl.auto' param. NO index creating");
		}
    ...
    /**
     * if jboss started with param, let's generate indexes
     * @return
     */
    private boolean needToUpdateSchema() {
        return "update".equals(System.getProperty("hibernate.hbm2ddl.auto"));
    }
