            ...
            if (medCase != null) {
                ...
                for (var ii = 0; ii < diagnosis.size(); ii++) {
                    ...
                    if (diag.priority != null && diag.priority.id == 1) {
                        ...
                        if (diag.traumaType != null) {
                            diagTravm = diagTravm + " " + diag.traumaType.name
                        }
                        if (diag.idc10Reason != null) {
                            diagTravmMkb = diagTravmMkb + " " + diag.idc10Reason.code + " " + diag.idc10Reason.name
                        }
                    }
