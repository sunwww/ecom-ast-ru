...
function getPassportInfo(aPassportType, aPassportSeries, aPassportNumber, aPassportDateIssue, aPassportWhomIssued) {
    ...
    if (aPassportSeries != null) {
        passport = passport + aPassportSeries;
    } else {
        passport = passport + "____________";
    }
    passport = passport + " номер ";
    if (aPassportNumber != null) {
        passport = passport + aPassportNumber;
    } else {
        passport = passport + "____________";
    }
    passport = passport + " выдан ";
    if (aPassportDateIssue != null) {
        passport = passport + FORMAT_2.format(aPassportDateIssue);
    } else {
        passport = passport + "____________";
    }
    passport = passport + " ";
    if (aPassportWhomIssued != null) {
        passport = passport + aPassportWhomIssued;
    } else {
        passport = passport + "______________________________";
    }
    return passport;
}

//#98 шаблоны лаб. анализов
