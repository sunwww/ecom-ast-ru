...
function updateCAOSbyCharged(aCtx,aDate1,aDate2) {
	...
	sql=sql+"	and mc.dateStart between cao.operationdate and cao.operationdate+7";
	...
	sql=sql+"	and ms.isPoliclinic='1' and ms.finishDate is null";
	sql=sql+"	and mc.dateStart between cao.operationdate and cao.operationdate+7 and caos.medcase_id is null";
