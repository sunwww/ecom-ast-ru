...
function createExtDispExamService(aCtx, aParams) {
    ...
    if (isPathology == "checked" || isPathology == "true" || isPathology == "on" || isPathology == "1") {
        isPathology = 1;
    } else {
        isPathology = 0;
    }
    if (deniedService == "checked" || deniedService == "true" || deniedService == "on" || deniedService == "1") {
        deniedService = 1;
    } else {
        deniedService = 0;
    }
...
function createExtDispVisitService(aCtx, aParams) {
    ...
    if (isEtdccSuspicion == "checked" || isEtdccSuspicion == "true" || isEtdccSuspicion == "on" || isEtdccSuspicion == "1") {
        isEtdccSuspicion = 1;
    } else {
        isEtdccSuspicion = 0;
    }
