...
function printDiagnosisJournal(aCtx, aParams) {
    ...
    if (typeMKB == 1) {
        mkbName = "substring(mkb.code,1,1)";
        mkbCode = "substring(mkb.code,1,1)";
        mkbLike = "1";
    } else if (typeMKB == 2) {
        mkbName = "substring(mkb.code,1,2)";
        mkbCode = "substring(mkb.code,1,2)";
        mkbLike = "1";
    } else if (typeMKB == 3) {
        mkbName = "substring(mkb.code,1,3)";
        mkbCode = "substring(mkb.code,1,3)";
        mkbLike = "1";
    }
    ...
    if (typeDate != null) {
        if (typeDate == 1) {
            fldDate = "slo.dateStart";
        } else if (typeDate == 3) {
            fldDate = "slo.transferDate";
        }
    }
    var isStat = true;
