...
function onCreate(aForm, aEntity, aCtx) {
    ...
    if (aCtx.getSessionContext().isCallerInRole("/Policy/Config/KKMWork") && defaultKkm!=null) {
        ...
        kkm.sendKKMRequest("makePayment", aEntity.getAccount().getId(), aForm.getDiscount(), aEntity.getIsPaymentTerminal() != null ? aEntity.getIsPaymentTerminal() : false, aForm.getCustomerPhone, fio, aCtx.manager,wf.id);
    }
    //**** ***//
}
