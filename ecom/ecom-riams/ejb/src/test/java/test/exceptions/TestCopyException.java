...
public class TestCopyException {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            test("TestCopyException$ExceptionTest: 4",copyException) ;
            test("TestCopyException$ExceptionTest: 3",copyException.getCause()) ;
            test("TestCopyException$ExceptionTest: 2",copyException.getCause().getCause()) ;
            test("TestCopyException$ExceptionTest: 1",copyException.getCause().getCause().getCause()) ;
