...
<msh:sideMenu title="Безопасность">
    <msh:sideLink styleId="users" action="/entityList-secuser.do" roles="/Policy/Jaas/SecUser/View"
                  name="Пользователи"/>
    ...
    <msh:sideLink styleId="policies" action="/entityParentList-secpolicy.do?id=1" roles="/Policy/Jaas/SecPolicy/View"
                  name="Политики"/>
