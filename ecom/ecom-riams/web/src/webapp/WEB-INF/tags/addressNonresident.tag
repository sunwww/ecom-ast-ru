    ...
    <div class='rootPane'>
        ...
        <form>
            <msh:panel colsWidth="1%,1%,1%,1%,1%,1%,1%,1%">
                <msh:row>
                    <msh:comboBox size='40' horizontalFill="true" property='${name}addressNonresidentTerritory'
                                  vocName="omcKodTer" label='Территория регистрации' fieldColSpan="7"/>
                </msh:row>
                <msh:row>
                    <msh:textField horizontalFill="true" fieldColSpan="7" label="Район проживания"
                                   property="${name}addressNonresidentRegion"/>
                </msh:row>
                <msh:row>
                    <msh:comboBox horizontalFill="true" property='${name}addressNonresidentTypeSettlement'
                                  vocName="omcQnp" label='Вид населенного пункта' fieldColSpan="7"/>
                </msh:row>
                <msh:row>
                    <msh:textField horizontalFill="true" fieldColSpan="7" label="Населенный пункт"
                                   property="${name}addressNonresidentSettlement"/>
                </msh:row>
                <msh:row>
                    <msh:comboBox horizontalFill="true" property='${name}addressNonresidentTypeStreet'
                                  vocName="omcStreetT" label='Тип улицы' fieldColSpan="7"/>
                </msh:row>
                <msh:row>
                    <msh:textField horizontalFill="true" fieldColSpan="7" label="Наименование улицы"
                                   property="${name}addressNonresidentStreet"/>
                </msh:row>
            ...
            <msh:row>
                <td colspan="6">
                    <input type="button" id='${name}buttonAddressOk' value='OK'
                           onclick='save${name}addressNonresident()'/>
