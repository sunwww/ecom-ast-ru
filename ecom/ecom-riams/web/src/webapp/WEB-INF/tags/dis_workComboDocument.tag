    ...
    <div class='rootPane'>
        ...
        <form action="javascript:">
            <msh:panel>
                ...
                <msh:row>
                    <msh:autoComplete vocName="disabilityDocumentByCase" property="${name}PrevDocument"
                                      label="Предыдущий документ" fieldColSpan="3" horizontalFill="true"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete label="Тип совместит.:" property="${name}WorkComboType" vocName="vocCombo"
                                      horizontalFill="true" fieldColSpan="3"/>
                </msh:row>
                <msh:row>
                    <msh:textField label="Место раб. по совмест:" property="${name}Job" horizontalFill="true"
                                   fieldColSpan="3"/>
                </msh:row>
