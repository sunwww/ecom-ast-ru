...
<msh:ifInRole roles="${roles}">
        ...
        <msh:panel>
            <div class="form-section">
                ...
                <div class="input-block">
                    <label><input disabled type="radio" name="age${name}" id="age1${name}" value="0" checked="">Младше
                        41
                        года</label>
                    ...
                    <label><input disabled type="radio" name="age${name}" id="age4${name}" value="3">Старше 75
                        лет</label>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div id="female-section${name}" class="input-block">
                        ...
                        <label><input type="checkbox" name="miscarriages${name}" value="1">
                            В анамнезе: необъяснимые мертворождения, выкидыши (≥3), преждевременные роды с токсикозом
                            или задержка
            ...
            <div class="form-section input-block">
                <h3>Мутации:</h3>
                <label><input class="calc-computing" type="checkbox" name="mutation-of-the-Leiden-type${name}"
                              value="3">
                    Мутация типа Лейден</label>
                <label><input class="calc-computing" type="checkbox" name="prothrombin-20210A-mutation${name}"
                              value="3">
            ...
            <div class="form-section input-block">
                ...
                <label><input class="calc-computing" type="checkbox" name="fracture-of-hip-and-shin-bones${name}"
                              value="5">
            ...
            <div class="form-section input-block">
                ...
                <label><input class="calc-computing" type="checkbox" name="hormone-replacement-therapy${name}"
                              value="1">
                    Гормонозаместительная терапия</label>
                <label><input class="calc-computing" type="checkbox" name="bed-rest-in-a-non-surgical-patient${name}"
                              value="1">
                    Постельный режим у нехирургического пациента</label>
                <label><input class="calc-computing" type="checkbox"
                              name="bed-rest-in-the-patient-for-more-than-72-hours${name}" value="2">
                ...
                <label><input class="calc-computing" type="checkbox"
                              name="inflammatory-diseases-of-the-colon-in-anamnesis${name}" value="1">
                    Воспалительные заболевания толстой кишки в анамнезе</label>
                <label><input class="calc-computing" type="checkbox"
                              name="large-surgical-intervention-prescription-up-to-1-month${name}" value="1">
                ...
                <label><input class="calc-computing" type="checkbox" name="central-venous-catheterization${name}"
                              value="2">
                ...
                <label><input class="calc-computing" type="checkbox" name="heparin-induced-thrombocytopenia${name}"
                              value="3">
                    Гепарин-индуцированная тромбоцитопения</label>
                <label><input class="calc-computing" type="checkbox"
                              name="elevated-levels-of-antibodies-to-cardiolipin${name}" value="3">
                ...
                <label><input class="calc-computing" type="checkbox" name="endoprosthetics-of-large-joints${name}"
                              value="5">
    ...
    <script type="text/javascript">
        ...
        function save${name}NewCalculation() {
            ...
            //отметка назначений и противопоказаний
