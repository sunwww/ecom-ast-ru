    ...
    <script type="text/javascript">
        ...
        function calculate${name}(){
            ...
            || isNaN(Createnin${name}.value) || isNaN(chss${name}.value=="") || isNaN(ad${name}.value=="") || isNaN(heartstop${name}.value=="")
                ...
                formToStirng+='Возраст:'; formToStirng+=age${name}.value;
                formToStirng+="\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t("+(t-tmp)+")";
                formToStirng+="\n";
                tmp=t;
                ...
                formToStirng+='ЧСС, уд/мин:'; formToStirng+=chss${name}.value;
                formToStirng+="\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t("+(t-tmp)+")";
                formToStirng+="\n";
                tmp=t;
                ...
                formToStirng+='Систолическое АД, мм. рт. ст.:'; formToStirng+=ad${name}.value;
                formToStirng+="\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t("+(t-tmp)+")";
                formToStirng+="\n";
                tmp=t;
                ...
                formToStirng+='Креатинин:'; formToStirng+=Createnin${name}.value;
                formToStirng+="\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t("+(t-tmp)+")";
                formToStirng+="\n";
                tmp=t;
                ...
                formToStirng+='Остановка сердца (на момент поступления) - '; formToStirng+=(heartstop${name}.checked)? 'Да':'Нет';
                formToStirng+="\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t("+(t-tmp)+")";
                formToStirng+="\n";
                tmp=t;
                if (st${name}.checked) t+=28;
                formToStirng+='Отклонение сегмента ST - '; formToStirng+=(st${name}.checked)? 'Да':'Нет';
                formToStirng+="\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t("+(t-tmp)+")";
                formToStirng+="\n";
                tmp=t;
                if (ferm${name}.checked) t+=14;
                formToStirng+='Высокий уровень сердечных ферментов - '; formToStirng+=(ferm${name}.checked)? 'Да':'Нет';
                formToStirng+="\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t("+(t-tmp)+")";
                formToStirng+="\n";
                tmp=t;
