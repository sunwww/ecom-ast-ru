    ...
    <div class='rootPane'>
        <form>
            <msh:panel>
                ...
                <msh:row>
                    <msh:checkBox property="${name}Hystology1"
                                  label="Направление на патологогистологическое исследование"/>
                </msh:row>
                <msh:row>
            ...
            <msh:row>
                <td colspan="6">
                    <input type="button" name="${name}DocumentsOk" id='${name}DocumentsOk' value='OK'
                           onclick='save${name}Documents()'/>
