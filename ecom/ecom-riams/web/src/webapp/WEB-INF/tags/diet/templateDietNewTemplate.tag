    ...
    <div class='rootPane'>
        ...
        <form>
            <msh:panel>
                ...
                <msh:autoComplete label="Шаблон" property="${name}templateMenu" vocName="vocMenuByDiet"
                                  horizontalFill="true" parentAutocomplete="${name}templateDiet" fieldColSpan="3"/>
                <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete label="Диета" showId="false" hideLabel="false" property="${name}newDiet"
                                      viewOnlyField="false" horizontalFill="true" fieldColSpan="3" vocName="Diet"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete showId="false" vocName="vocServiceStream" hideLabel="false"
                                      property="${name}newServiceStream" viewOnlyField="false"
                                      label="Поток обслуживания" horizontalFill="true" fieldColSpan="3"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete vocName="vocWeekDay" property="${name}newWeekDay" label="День недели"
