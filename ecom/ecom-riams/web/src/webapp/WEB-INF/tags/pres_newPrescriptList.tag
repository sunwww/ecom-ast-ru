...
<div id='${name}PrescriptListDialog' class='dialog'>
    ...
    <div style="display: none" id="executeLabSurveyDiv">
        <table>
            <tr>
                <msh:autoComplete label="Лабораторная услуга" property="${name}NewService" vocName="labMedService"
                                  parentId="0" size="50"/>
            </tr>
            <tr>
                <td colspan="2" style="alignment: center">
                    <input type="button" value="Выбрать и внести данные"
                           onclick="this.disabled=true;createNewPrescription()">
    ...
    <div class='rootPane'>
        ...
        <form action="javascript:">
            <table id='tablePrescriptList'>
                ...
                <tr>
                    <td>
                        <input name="add" type='button' onclick="javascript:goTo('diagnostic')"
                               value='Добавить диагностическое исследование'>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input name="add" type='button' onclick="javascript:goTo('operation')"
                               value='Добавить назначение на операцию'>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <input name="add" type='button' onclick="javascript:goTo('drugShort')"
                               value='Добавить назначение наркотика'>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <input name="view" type='button' onclick="javascript:goTo('view')"
                               value='Просмотреть назначения'>
                    </td>
                </tr>
                <tr>
                    <td>
                        <input name="cancel" type='button' onclick="javascript:cancel${name}PrescriptList()"
                               value='Ничего не надо, я передумал'>
                    </td>
                </tr>
                <msh:ifInRole roles="/Policy/Mis/Prescription/ServicePrescription/CreateAndExecute">
                    <tr>
                        <td>
                            <input name="cancel" type='button' onclick="javascript:createAndExecutePrescription()"
                                   value='Ввести результат анализа'>
                        </td>
                    </tr>
                </msh:ifInRole>
            </table>
...
<script type="text/javascript">
    ...
    function checkLabControl(aPrescriptId) {
        PrescriptionService.checkLabontrolByPrescriptionId(aPrescriptId, {
            callback: function () {
                alert("Данные об анализе добавлены!");
    ...
    function getParameterById(id) {
        var ret = jQuery.grep(fldJson.params, function (el) {
            return el.id == id;
        });
        return ret ? ret[0] : {};
    }
