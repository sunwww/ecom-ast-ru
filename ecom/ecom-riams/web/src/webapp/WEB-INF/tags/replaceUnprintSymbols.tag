    ...
    <div class='rootPane'>
        ...
        <form action="javascript:void(0) ;" id="formId">
            ...
            <table width="100%" cellspacing="10" cellpadding="10">
                ...
                <tr>
                    <td align="center"><input type="button" value='Ок' style="font-weight:bold"
                                              onclick='javascript:${name}Save()'/></td>
                    <td align="center"><input type="button" value='Отмена'
                                              onclick='javascript:the${name}ReplaceSymbsDialog.hide();'/></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
            ...
            for (var i = 0; i < record${name}.length; i++) {
                ...
                if (!checkCode(code)) {
                    if (masAll${name}.indexOf(record${name}[i]) == -1) { //символ для замены выводится один раз и заменяется везде
                        ...
                        tdLeft.align = "center";
                        tdRight.align = "center";
                        tdSymbol.align = "center";
                        tdRepl.align = "center";
