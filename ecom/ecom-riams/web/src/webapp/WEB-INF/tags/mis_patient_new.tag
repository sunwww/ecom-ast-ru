    ...
    <div class='rootPane'>
        ...
        <form action="javascript:save${name}Patient()">
            <msh:panel styleId="panel${name}">
                ...
                <msh:row>
                    <msh:textField property="${name}Middlename" label="Отчество" fieldColSpan="3"
                                   horizontalFill="true"/>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete property="${name}SocialStatus" label="Соц.статус" vocName="vocSocialStatus"
            ...
            <div id='div${name}Button'>
                <msh:row>
                    <td colspan="6">
                        <input type="button" value='Сохранить' id="${name}Ok"
                               onclick="javascript:save${name}Patient()"/>
                        <input type="button" value='Отменить' id="${name}Cancel"
                               onclick='javascript:cancel${name}Patient()'/>
                    </td>
                </msh:row>
            </div>
        </form>
