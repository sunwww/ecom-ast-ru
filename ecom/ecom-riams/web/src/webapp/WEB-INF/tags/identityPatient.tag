...
<div id='${name}Dialog' class='dialog'>
    ...
    <div>
        <form id="${name}">
            <msh:panel>
                <msh:row>
                    <msh:comboBox size='300' horizontalFill="true" property='${name}vocColorIdentityPatient'
                                  vocName="vocColorIdentityPatient" label='Выберите:'/>
                </msh:row>
            </msh:panel>
        </form>
    </div>
        ...
        <table width="100%" cellspacing="10" cellpadding="10">
            <tr>
                <td align="center"><input type="button" value='Добавить' id="${name}Add"
                                          onclick='javascript:addIdentityPatient${name}()'/></td>
            </tr>
            <tr>
                <td></td>
            </tr>
