...
<div id='${name}templateDietDialog' class='dialog'>
    ...
    <div class='rootPane'>
        ...
        <form>
            <msh:panel>
                <msh:row>
                    <msh:autoComplete label="Диета" property="${name}templateDiet" vocName="Diet"
                                      horizontalFill="true"/>
                </msh:row>
                <msh:autoComplete label="Шаблон" property="${name}templateMenu" vocName="vocMenuByDiet"
                                  horizontalFill="true" parentAutocomplete="${name}templateDiet"/>
                <msh:row>
