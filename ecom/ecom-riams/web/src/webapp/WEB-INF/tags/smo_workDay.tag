    ...
    <div id='${name}WorkCalendar' class='dialog'>
        ...
        <div class='rootPane'>
            ...
            <msh:ifInRole roles="/Policy/Mis/MedCase/Visit/ViewAll">
                <msh:panel>
                    <msh:autoComplete size="120" property="${name}WorkFunction" label="Рабочая функция"
                                      vocName="workFunctionByDirect" horizontalFill="true"/>
            ...
            <div style="float: right;">
                <input type="button" onclick="javascript:save${name}WorkCalendar()" value='OK' id='${name}ButtonOk'
                       name='${name}ButtonOk'/>
