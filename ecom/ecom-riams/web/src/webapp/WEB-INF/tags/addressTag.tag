...
<div id='addressDialog' class='dialog'>
    ...
    <div class='rootPane'>
        ...
        <form>
            <msh:panel>
                <msh:row>
                    <msh:comboBox size='40' horizontalFill="true" property='address_1' vocName="Address-1"
                                  label='Страна:' fieldColSpan="7"/>
                </msh:row>
                <msh:row>
                    <msh:comboBox horizontalFill="true" property='address_2' vocName="Address-2" label='Регион:'
                                  fieldColSpan="7"/>
                </msh:row>
                <msh:row>
                    <msh:comboBox horizontalFill="true" property='address_3' vocName="Address-3" label='Район области:'
                                  fieldColSpan="7"/>
                </msh:row>
                <msh:row>
                    <msh:comboBox horizontalFill="true" property='address_4' vocName="Address-4" label='Город:'
                                  fieldColSpan="7"/>
                </msh:row>

                <msh:row>
                    <msh:comboBox horizontalFill="true" property='address_5' vocName="Address-5"
                                  label='Населенный пункт:' fieldColSpan="7"/>
                </msh:row>
                <msh:row>
                    <msh:comboBox horizontalFill="true" property='address_6' vocName="Address-6" label='Улица:'
                                  fieldColSpan="7"/>
                </msh:row>
