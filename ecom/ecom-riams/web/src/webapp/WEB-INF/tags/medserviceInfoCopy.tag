...
<div id='${name}CloseMsTemplDialog' class='dialog'>
    ...
    <div>
        <form id="${name}">
            <msh:panel>
                <msh:row>
                    <msh:autoComplete property="ms${name}" fieldColSpan="7" horizontalFill="true" label="Мед. услуга"
                                      vocName="medServiceAll" size="100"/>
                </msh:row>
            </msh:panel>
        </form>
    </div>
    ...
    <div>
        <table width="100%" cellspacing="10" cellpadding="10">
            <tr>
                ...
                <td align="center"><input type="button" style="font-weight:bold" id="${name}203" value='Закрыть'
