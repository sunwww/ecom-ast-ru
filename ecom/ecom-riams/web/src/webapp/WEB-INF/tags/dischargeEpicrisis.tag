            ...
            <msh:panel>
                <msh:ifInRole roles="/Policy/Mis/MedCase/Document/External/Medservice/View">
                    ...
                    <tr onclick="show${name}DiariesDiv()">
                        ...
                        <td>
                            <label><input type="radio" name="${name}showTypeService" value="LAB">Лабораторные
                                исследования</label>
                        </td>
                        <td>
                            <label><input type="radio" name="${name}showTypeService" value="DIAG">Диагностические
                                исследования</label>
                        </td>
                    </tr>
                    <msh:row>
                        ...
                        <td onclick="format${name}Services();">
                            <label> <input type="checkbox" id="${name}ExtLabsOrder"/> Обратный порядок (от старых к
                                новым)</label>
                        </td>
                    </msh:row>
                    <msh:row>
                        <td></td>
                        <td onclick="format${name}Services();">
                            <label><input type="checkbox" name="${name}ExtLabsStr" id="${name}ExtLabsStr"
                                          checked="checked"> Преобразовать в одну строку</label>
                        </td>
                    </msh:row>
                    <msh:row>
                        <td></td>
                        ...
                        <td onclick="this.childNodes[1].checked='checked';format${name}Services();">
                            <input type="radio" name="${name}ExtLabsCode" checked="checked" value="1"> Показывать
                            название услуги
                        </td>
                        <td onclick="this.childNodes[1].checked='checked';format${name}Services();">
                    ...
                    <msh:row>
                        <td></td>
                        <td onclick=" format${name}Services();">
                            <label><input type="checkbox" name="${name}ExtLabsNoIntake" id="${name}ExtLabsNoIntake"
                                          checked="checked"> Убрать инф. о заборе</label>
                        </td>
                    </msh:row>
                    <msh:row>
                        <td></td>
                        <td onclick=" format${name}Services();">
                            <label><input type="checkbox" name="${name}NoLabTechnik" id="${name}NoLabTechnik"
                                          checked="checked"> Убрать инф. о лаборанте</label>
                        </td>
                    </msh:row>
                    <msh:row>
                        <td></td>
                        <td onclick=" format${name}Services();">
                            <label><input type="checkbox" name="${name}NoRefValues" id="${name}NoRefValues"
                                          checked="checked"> Убрать инф. о реф. инт.</label>
                        </td>
                    </msh:row>
                    <msh:row>
                        <td></td>
                        <td onclick=" format${name}Services();">
                            <label><input type="checkbox" name="${name}ExtLabsDate" id="${name}ExtLabsDate"> Добавить
                                дату выполнения услуги</label>
                        </td>
                    </msh:row>
                </msh:ifInRole>
                ...
                <msh:row>
                    <td colspan="6">
                        <input type="button" name="${name}EpicrisisOk" id='${name}EpicrisisOk' value='OK'
                               onclick='save${name}Epicrisis()'/>
