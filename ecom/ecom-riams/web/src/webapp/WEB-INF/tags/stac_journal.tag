...
<msh:sideMenu title="Журналы">
    ...
    <msh:sideMenu title="СЛО">
        ...
        <msh:sideLink
                ...
                action="/pres_journal_intake.do?service=22347"
                roles="/Policy/Mis/Journal/Prescription/LabSurvey/IntakeByCurrentDepartmentDoctor1"/>
    </msh:sideMenu>
    <msh:sideMenu title="Журналы">
        <msh:sideLink
        ...
        <msh:sideLink styleId="journal_doc_externalMedService"
                      ...
                      action="/journal_searchEmptyCovid.do"
                      name="Поиск госпитализаций, в которых не создана карта COVID"
        />
    </msh:sideMenu>
</msh:sideMenu>
