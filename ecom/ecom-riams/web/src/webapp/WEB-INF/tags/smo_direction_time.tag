...
<div id='${name}WorkCalendar' class='dialog'>
    ...
    <div class='rootPane'>
        <table width='100%'>
            ...
            <msh:row>
                <msh:autoComplete vocName="vocWorkFunction" property="${name}VocWorkFunction" label="Должность"
                                  horizontalFill="true" fieldColSpan="5"/>
                <td><input type="button" value='Поиск' id='${name}ButtonFind' name='${name}ButtonFind'
                           onclick='load${name}Data()' title="Поиск"/></td>
                    ...
                    <div class="x-box-mc">
                        ...
                        <div class="x-grid-container xedit-grid"
                            ...
                            <div id="ext-gen39" class="x-grid" hidefocus="false"
                                ...
                                <div id="ext-gen46" class="x-grid-scroller"
...
<script type="text/javascript">
    ...
    function save${name}WorkCalendar(aWorkFunctionId, aCalDayId, aTime, aWorkFunctionInfo, aCalDayInfo, aMinIs) {
        ...
        WorkCalendarService.getCalendarTimeId(aCalDayId, aTime, aMinIs, {
