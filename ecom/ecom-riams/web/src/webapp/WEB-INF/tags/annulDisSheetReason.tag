    ...
    <div class='rootPane'>
        ...
        <form action="javascript:void(0) ;" id="formId">
            ...
            <table width="100%" cellspacing="10" cellpadding="10">
                ...
                <tr>
                    <td align="center"><input type="button" value='Аннулировать' style="font-weight:bold"
                                              id="${name}nul" onclick='javascript:${name}ElectronicDocument(this)'/>
                    </td>
                    <td align="center"><input type="button" value='Закрыть' id="${name}Cancel"
                                              onclick='javascript:cancel${name}CloseElectronicDocument()'/></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
...
<script type="text/javascript">
    ...
    function showPossibleReasons() {
        DisabilityService.getReasonsfOfAnnulSheets({
    ...
    function ${name}ElectronicDocument(aButton) {
        ...
        if (code == ""/* || text==""*/) {
            ...
            DisabilityService.setAnnulDisabilityDocument(${param.id}, text, code, {
                callback: function (res) {
                    the${name}AnnulDisDocumentDialog.hide();
