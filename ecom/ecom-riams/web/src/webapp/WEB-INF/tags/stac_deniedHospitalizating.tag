    ...
    <div id='${name}DeniedHospitalizatingDialog' class='dialog'>
        ...
        <div class='rootPane'>
            ...
            <form action="javascript:">
                <msh:panel>
                    <msh:row>
                        <msh:autoComplete property="${name}DeniedHospitalizating" label="Отказ от госпитализации"
                                          size="100" vocName="vocDeniedHospitalizating"/>
                    </msh:row>
                </msh:panel>
                <msh:row>
                    <td colspan="6">
                        ...
                        <input type="button" value='Отменить'
                               onclick='javascript:cancel${name}DeniedHospitalizating()'/>
                    </td>
                </msh:row>
            </form>
