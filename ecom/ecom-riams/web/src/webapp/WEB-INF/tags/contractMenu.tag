...
<msh:sideMenu title="Списки">
    ...
    <msh:sideLink styleId="guaranteeGroup"
                  ...
                  name="групп гарантийных документов"
                  roles="/Policy/Mis/Contract/GroupRules/ContractGuaranteeGroup/View"
...
<msh:sideMenu title="Отчеты">
    <msh:sideLink styleId="controlReport"
                  ...
                  name="Контрольный отчет"
                  roles="/Policy/Mis/Contract/Journals/Control,/Policy/Mis/Contract/MedContract/View,/Policy/Mis/Contract/MedContract/ServedPerson/ContractAccount/ContractAccountOperation/View"
                  title="Контрольный отчет"
    />
    <msh:sideLink styleId="controlReportNoAccrual"
                  action="/contact_analisis_no_accrual"
                  name="Контрольный отчет по счетам на оплату"
                  roles="/Policy/Mis/Contract/Journals/ControlNoAccrual,/Policy/Mis/Contract/MedContract/View,/Policy/Mis/Contract/MedContract/ServedPerson/ContractAccount/ContractAccountOperation/View"
    ...
    <msh:sideLink styleId="serviciesReport"
                  ...
                  roles="/Policy/Mis/Contract/Journals/Servicies,/Policy/Mis/Contract/MedContract/View,/Policy/Mis/Contract/MedContract/ServedPerson/ContractAccount/ContractAccountOperation/View"
                  title="Разбивка по услугам"
    />
    <msh:sideLink styleId="serviciesReportGroup"
                  action="/contract_reports_services_group"
                  name="Отчет по услугам (группы)"
                  roles="/Policy/Mis/Contract/Journals/Servicies,/Policy/Mis/Contract/MedContract/View,/Policy/Mis/Contract/MedContract/ServedPerson/ContractAccount/ContractAccountOperation/View"
    ...
    <msh:sideLink styleId="nationalityReportGroup"
                  ...
                  name="Сведения об оказанной мед. помощи иногородним и иностранным гражданам"
                  roles="/Policy/Mis/Contract/Journals/Servicies,/Policy/Mis/Contract/MedContract/View,/Policy/Mis/Contract/MedContract/ServedPerson/ContractAccount/ContractAccountOperation/View"
    ...
    <msh:sideLink styleId="financeReport"
                  ...
                  roles="/Policy/Mis/Contract/Journals/Finance,/Policy/Mis/Contract/MedContract/View,/Policy/Mis/Contract/MedContract/ServedPerson/ContractAccount/ContractAccountOperation/View"
