    ...
    <div id='${name}ChoiceSpoDialog' class='dialog'>
        ...
        <div class='rootPane'>
            ...
            <form action="javascript:void(0)" id="${name}frmSpo" name="${name}frmSpo">
                ...
                <msh:row>
                    <td colspan="6">
                        <input type="button" value='Перенести в выбранный СПО'
                               onclick="javascript:save${name}ChoiceSpo(1)"/>
                        <input id="${name}InNewSpo" name="${name}InNewSpo" type="button" value='Перенести в новый СПО'
                               onclick="javascript:save${name}ChoiceSpo(0)"/>
