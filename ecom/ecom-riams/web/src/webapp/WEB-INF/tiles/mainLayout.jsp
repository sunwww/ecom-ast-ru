...
<html:html xhtml="true" locale="true">
    ...
    <div id='header' style="${style_addition_body}">
        ...
        <ul id='user'>
            ...
            <msh:ifInRole roles="/Policy/Mis/CustomMessage/View">
                ...
                <li><a href='javascript:void(0)'
                       onclick='getDefinition("js-mis_customMessage-getMessages.do?id=-1&short=Short")'>Сообщения</a>
                </li>
            </msh:ifInRole>
            ...
            <li class="separator">|</li>
            <li><a href='javascript:void(0)'
                   onclick='getDefinition("js-riams-instructions.do?short=Short")'>Инструкции</a>
            </li>
            <li class="separator">|</li>
            ...
            <li>
                ...
                <msh:ifNotInRole roles="/Policy/Mis/Help/Edit">
                    <a href='javascript:void(0)'
                       onclick='getDefinition("mis_help.do?code="+escape("${servletPath}")+"&nextUrl="+escape(window.location))'>Помощь</a>
                </msh:ifNotInRole>
                <msh:ifInRole roles="/Policy/Mis/Help/Edit">
                    <a href='javascript:void(0)'
                       onclick='window.open("mis_help.do?code="+escape("${servletPath}")+"&nextUrl="+escape(window.location))'>Помощь</a>
                </msh:ifInRole>
            </li>
            <li class="separator">|</li>
            ...
            <li class="separator">|</li>
            <li><a href="javascript:ws_exit();window.location = 'ecom_relogin.do?next='+escape(window.location);">Войти
                под др. именем</a></li>
            <li class="separator">|</li>
        ...
        <ul id='mainMenu'>
            ...
            <msh:sideLink params="" styleId="mainMenuPoly" action="/js-smo_visit-findPolyAdmissions.do"
            ...
            <msh:sideLink params="" styleId="mainMenuStacJournal" action="/stac_findSlsByStatCard.do"
                          name="Журнал обращений"
                          roles="/Policy/MainMenu/AdmissionJournal" title="Журнал обращений"/>
            <msh:sideLink params="" styleId="mainMenuLaboratoryJournal" action="/pres_prescription_find.do"
                          name="Лаборатория"
            ...
            <msh:sideLink params="" styleId="mainMenuExpert2Pregnant" action="/riams_edkc.do?preg=Pregnant&title=жен."
                          name="ЕДКЦ жен."
    ...
    <div id="footer" class="rightAlign">
        ...
        <div id='gotoUpDown'><a class="gotoTop" href="#header">Вверх</a><a class="gotoBottom" href="#copyright">Вниз</a>
        </div>
        ...
        <msh:ifInRole roles="/Policy/WebSocket/Queue">
            <div class='ws_workerDiv'>
                <p id='ws_windowWorkDiv' title="Нажмите для изменения номера окна"
                   onclick="ws_setNewWindowNumber()"></p>
                <hr/>
                <p id='ws_finishWorkDiv' title="Нажмите чтобы приступить к работе/прекратить работу в очереди">
                    СТАТУС</p>
            </div>
            <div class="ws_ticketDiv">
                <p id='ws_ticketNumberDiv' title="Текущий талон"
                   onclick="alert('Текущий талон = '+jQuery('#ws_ticketNumberDiv').html())">---</p>
                <hr/>
                <p id='ws_nextTicketDiv' title="Нажмите для перехода к следующему талону" onclick='ws_setNewTicket()'>
                    Перейти к следующему талону</p>
            </div>
        </msh:ifInRole>
    </div>

    <div id='copyright' style="float: right;">&copy; МедОС (v.
        <%@ include file="/WEB-INF/buildnumber.txt" %>
        )
    </div>
    ...
    <msh:ifInRole roles="/Policy/Config/CustomizeMode/Edit">
        ...
        <div id='ideModeMainMenuClose'
             onclick="javascript:$('ideModeMainMenu').style.display=='none'?$('ideModeMainMenu').style.display='block':$('ideModeMainMenu').style.display='none'">
            Показать меню x
        </div>
