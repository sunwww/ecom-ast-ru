...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
  ...
  <msh:ifInRole roles="/Policy/MainMenu/Patient">
    ...
    <msh:sideMenu>
        ...
        <msh:sideLink roles="/Policy/Mis/Patient/Create" key="ALT+N" action='/entityPrepareCreate-smo_stream_short_spo.do' name="Добавить обращение" guid="4cecc5e2-4e6b-4196-82ef-bf68124d90a5" />
        <msh:sideLink roles="/Policy/Mis/Patient/Create" key="ALT+M" action='/entityPrepareCreate-smo_stream_ticket_spo.do' name="Добавить посещение" guid="4cecc5e2-4e6b-4196-82ef-bf68124d90a5" />
