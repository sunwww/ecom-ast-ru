...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
        ...
        <msh:form action="/entitySaveGoView-e2_vocKsg.do" defaultField="name">
            ...
            <msh:panel>
                ...
                <msh:row>
                    ...
                    <msh:autoComplete property="group" vocName="vocKsgGroup" fieldColSpan="3" size="100"
                                      viewOnlyField="true"/>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    <msh:textField property="doctorCost"/>
                </msh:row>
                <msh:row>
  ...
  order by c.startDate"/>
        <msh:section title='КУКСГ' createUrl="entityParentPrepareCreate-e2_vocKsgKuksg.do?id=${param.id}">
            ...
            <msh:table deleteUrl="entityDelete-e2_vocKsgKuksg.do" name="kuksgList" printToExcelButton="в excel"
                       action="entityParentEdit-e2_vocKsgKuksg.do" idField="1">
