...
"/>
                ...
                <msh:table  name="listAll" styleRow="6" action="entityView-e2_vocMedHelpProfile.do" idField="1" disableKeySupport="true">
                    <msh:tableColumn columnName="Профиль"  property="2" guid="5b05897f-5dfd-4aee-ada9-d04244ef20c6" />
                    ...
                    <msh:tableColumn columnName="Мед. специальность (V021)"  property="5" guid="5b05897f-5dfd-4aee-ada9-d04244ef20c6" />
                    <msh:tableColumn columnName="Профиль койки"  property="4" guid="5b05897f-5dfd-4aee-ada9-d04244ef20c6" />
                </msh:table>
            </msh:section>
        </msh:hideException>
    </tiles:put>
