...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="body" type="string">
    <msh:form action="/poly_ticketsByUserList.do" defaultField="department" disableFormDataConfirm="true" method="GET">
    <msh:panel>
      <msh:row>
    ...
    from Ticket where ${dateSearch}  between to_date('${param.dateBegin}','dd.mm.yyyy')  
    	and to_date('${dateEnd}','dd.mm.yyyy')
    	 ${add} group by ${dateSearch},usernameCreate" />
