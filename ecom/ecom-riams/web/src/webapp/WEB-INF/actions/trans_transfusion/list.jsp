...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="side" type="string">
    <msh:sideMenu title="Добавить">
            <msh:sideLink roles="/Policy/Mis/MedCase/Transfusion/Blood/Create" params="id" action="/entityParentPrepareCreate-trans_blood" name="Протокол трансфузии" title="Добавить Протокол трансфузии" />
