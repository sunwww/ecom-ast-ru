...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="body" type="string">
    ...
    select ms.id,ms.code,ms.name as msname,vwf.name as vwfname,vbt.name as vbtname,vbst.name as vbstname,vrt.name as vrtname,vms.code as vmscode
    from medservice ms
 ...
 "/>
        <msh:table name="journal_double_visit" action="entityView-mis_medService.do" idField="1" noDataMessage="Не найдено">
            ...
            <msh:tableColumn columnName="Код внеш" property="8"/>
