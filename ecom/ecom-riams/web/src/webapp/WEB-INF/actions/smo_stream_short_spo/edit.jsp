...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
  ...
  <tiles:put name="body" type="string">
    ...
    <msh:form method="post" guid="formHello" action="/entitySaveGoView-smo_stream_short_spo.do"  defaultField="dateStart" > 
      ...
      <msh:hidden guid="hiddenSaveType" property="saveType" />
            ...
            <msh:ifFormTypeIsView formName="smo_stream_short_spoForm">
            <script type="text/javascript">
            
            window.document.location = 'entityPrepareCreate-smo_stream_short_spo.do?';
            </script>
      ...
      <msh:panel guid="panel">
        ...
        <msh:ifFormTypeIsNotView formName="smo_stream_short_spoForm">
        ...
        <msh:row>
        	...
        	parentId="smo_stream_short_spoForm.medcard" vocName="kinsmanByTicket" horizontalFill="true" fieldColSpan="3"/>
        </msh:row>
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail guid="titleTrail-123" mainMenu="Patient" beginForm="smo_stream_short_spoForm" />
  </tiles:put>
  <tiles:put name="side" type="string">
    <msh:ifFormTypeIsView formName="smo_stream_short_spoForm" guid="625411c7-8b7e-4d5b-acae-4fe679e24094">
