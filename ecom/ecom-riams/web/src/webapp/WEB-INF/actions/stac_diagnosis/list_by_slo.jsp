...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  %>
    <msh:form action="/stac_diagnosis_by_slo_list.do" defaultField="department" disableFormDataConfirm="true" method="GET">
    <msh:panel>
...
+case when (cast(to_char(${fldDate}, 'mm') as int)-cast(to_char(pat.birthday, 'mm') as int)) <0 then -1 when (cast(to_char(${fldDate},'dd') as int) - cast(to_char(pat.birthday,'dd') as int)<0) and ((cast(to_char(${fldDate}, 'mm') as int)-cast(to_char(pat.birthday, 'mm') as int)-1)<0)  then -1 else 0 end
    ...
    <msh:table name="datelist" action="entityParentView-stac_slo.do" idField="1">
      ...
      <msh:tableColumn columnName="Адрес" property="10"/>
      <msh:tableColumn columnName="Дата рождения" property="6"/>
      <msh:tableColumn columnName="Возраст" property="11"/>
      <msh:tableColumn columnName="Дата поступления" property="2"/>
      <msh:tableColumn columnName="Дата выписки" property="3"/>
      <msh:tableColumn columnName="Кол-во к.дней" property="12"/>
      <msh:tableColumn columnName="Госпитализация" property="9"/>
    ...
    <msh:table name="datelist" viewUrl="entityShortView-stac_slo.do" action="entityParentView-stac_slo.do" idField="1">
      ...
      <msh:tableColumn columnName="Дата поступления" property="2"/>
      <msh:tableColumn columnName="Госпитализация" property="9"/>
      <msh:tableColumn columnName="МКБ" property="8"/>
