...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="body" type="string">
  	<ecom:webQuery name="listArch" nativeSql="select wf.id
  	,wp.lastname||' '||wp.firstname||' '||wp.middlename as fio
  	, vwf.name as vwfname, gr.groupName as grgroupName 
  	from workfunction wf left join worker w on w.id=wf.worker_id 
    ...
    <msh:table name="listArch" viewUrl="entitySubclassShortView-work_workFunction.do" action="entitySubclassView-work_workFunction.do" idField="1">
