...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        %>
        <msh:form action="/entityParentSaveGoView-pres_drugShortPrescription.do" defaultField="id"
                  title="Назначение наркотического средства">
            <msh:hidden property="id"/>
            <msh:hidden property="prescriptionList"/>
            <msh:hidden property="saveType"/>
            <msh:panel colsWidth="3">
                <msh:row>
                    <msh:autoComplete vocName="vocDrug" property="vocDrug" label="Лекарственный препарат"
        ...
        <msh:ifFormTypeIsView formName="pres_drugShortPrescriptionForm">
            ...
            <msh:sideMenu title="Перейти">
                <msh:sideLink roles="/Policy/Mis/Prescription/DrugPrescription/View" params="id"
                              action="/entityParentListRedirect-pres_drugShortPrescription"
