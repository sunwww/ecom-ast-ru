...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="title" type="string">
    <msh:title guid="helloItle-123" mainMenu="Journals" title="Журнал экстренных извещений об инфекционных заболеваниях" />
  </tiles:put>
  ...
  <tiles:put name="body" type="string">
    <msh:section guid="863b6d75-fded-49ba-8eab-108bec8e092a">
      <msh:sectionTitle guid="1dcd4d93-235d-4141-a7ee-eca528858925">Результаты поиска за дату с ${param.id}.<msh:link action="journal_infectMessage.do">Выбрать другую дату</msh:link></msh:sectionTitle>
      <msh:sectionContent guid="ab8e5a72-aadd-4c65-8691-2205506e63dc">
        <ecom:webQuery name="listInf" nativeSql="select pm.id&#xA; ,pat.lastname || ' ' || pat.firstname || ' ' || pat.middlename&#xA; ,pat.birthday&#xA; ,pm.number, pm.phoneDate, pm.phoneTime,pm.phone,pm.recieverOrganization from PhoneMessage pm left join MedCase ms on pm.medCase_id=ms.id left join Patient pat on ms.patient_id = pat.id  where pm.phoneMessageType_id=1 and pm.phoneDate='${param.id}' " guid="909fd277-28b6-4ce3-841c-7d76ee74c9e0" />
