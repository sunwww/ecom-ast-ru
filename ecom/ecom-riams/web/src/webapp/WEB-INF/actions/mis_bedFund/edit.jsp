...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
        ...
        <msh:form action="/entityParentSaveGoView-mis_bedFund.do" defaultField="amount">
            ...
            <msh:panel>
                ...
                <msh:row>
                    ...
                    <msh:checkBox property="addCaseDuration" fieldColSpan="3"
                                  label="День выписки и день поступления считать разными днями"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete vocName="vocBedSubType" property="bedSubType" label="Тип коек"
                                      horizontalFill="true" fieldColSpan="3"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete vocName="vocBedReductionType" property="reductionType" label=""
                                      horizontalFill="true" fieldColSpan="3"/>
                </msh:row>
                <msh:row>
                ...
                <msh:textField property="vmpDepartmentAddressCode" label="Код F100 для выгрузки в ФОМС ВМП"
                               fieldColSpan="3" size="50"/>
            </msh:row>
    ...
    <tiles:put name="side" type="string">
        <msh:ifFormTypeIsView formName="mis_bedFundForm">
            <msh:sideMenu>
                <msh:sideLink key="ALT+2" params="id" action="/entityEdit-mis_bedFund" name="Изменить"
                              roles="/Policy/Mis/BedFund/Edit"/>
                <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id" action="/entityParentDelete-mis_bedFund"
