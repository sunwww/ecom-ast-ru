...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="side" type="string">
        <msh:sideMenu>
            <msh:sideLink roles="/Policy/Mis/BedFund/Create" key="ALT+N" action="/entityParentPrepareCreate-mis_bedFund"
                          name="Создать новое" params="id"/>
        </msh:sideMenu>
    </tiles:put>
    <tiles:put name="body" type="string">
        <msh:table name="list" action="entityParentView-mis_bedFund.do" idField="id">
            ...
            <msh:tableColumn columnName="Код F100" property="departmentAddressCode"/>
        </msh:table>
    </tiles:put>
</tiles:insert>
