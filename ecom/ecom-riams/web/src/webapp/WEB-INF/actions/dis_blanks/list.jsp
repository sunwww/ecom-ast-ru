...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="title" type="string">
    <msh:title mainMenu="Disability">Бланки документов нетрудоспособности (выданных/сданных)</msh:title>
  </tiles:put>
  <tiles:put name="side" type="string">
    <msh:sideMenu>
      <msh:sideLink roles="/Policy/Mis/Disability/Blanks/Create" key="ALT+N" action="/entityPrepareCreate-dis_blanks" name="Создать новое" />
    </msh:sideMenu>
  </tiles:put>
