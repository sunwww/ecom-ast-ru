...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="side" type="string">
        <msh:sideMenu title="Добавить">
            <msh:sideLink params="id" roles="/Policy/Mis/Prescription/ServicePrescription/Create" key="ALT+N"
                          action="/entityParentPrepareCreate-pres_servicePrescription" name="Назначение на услугу"/>
        </msh:sideMenu>
        <msh:sideMenu title="Показать">
            <msh:sideLink roles="/Policy/Mis/Prescription/View" params="id" action="/entityParentList-pres_prescription"
                          name="К списку назначений" title="Показать список назначений"/>
        </msh:sideMenu>
    </tiles:put>
