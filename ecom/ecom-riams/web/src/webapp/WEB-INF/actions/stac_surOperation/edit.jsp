...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        %>
        <msh:form action="/entityParentSaveGoSubclassView-stac_surOperation.do" defaultField=""
            ...
            <msh:panel colsWidth="15px,250px,15px">
                ...
                <msh:ifNotInRole roles="/Policy/Mis/MedCase/Stac/Ssl/ShortEnter">
                    ...
                    <msh:row>
                        <msh:autoComplete property="idc10Before" label="МКБ до операции" fieldColSpan="3"
                                          horizontalFill="true" vocName="vocIdc10"/>
                    </msh:row>
                </msh:ifNotInRole>
                ...
                <msh:row>
                    <msh:autoComplete property="serviceStream" label="Поток обслуживания" fieldColSpan="3"
                                      horizontalFill="true" vocName="vocServiceStream"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete label="Хирург" property="surgeon" horizontalFill="true" fieldColSpan="3"
                                      vocName="workFunctionIsSurgical"/>
                </msh:row>
                <msh:ifFormTypeIsView formName="stac_surOperationForm">
                    <msh:row>
                        <msh:autoComplete property="operation" label="Операция" size="60" fieldColSpan="3"
                                          horizontalFill="true" vocName="vocOperation"/>
                    </msh:row>
                </msh:ifFormTypeIsView>
                <msh:row>
                    <msh:autoComplete property="medService" label="Операция (услуга)" size="60" fieldColSpan="3"
                                      horizontalFill="true" vocName="medServiceOperation"/>
                </msh:row>
                <mis:ifPatientIsWoman classByObject="MedCase" idObject="${medcase}">

                    <msh:row>
                        <msh:autoComplete property="profile" label="Профиль" horizontalFill="true"
                                          vocName="vocSurgicalProfile"/>
                        <msh:autoComplete property="method" label="Метод" horizontalFill="true"
                                          vocName="vocOperationMethod"/>
                    </msh:row>

                    <msh:row>
                        <msh:autoComplete property="abortion" vocName="vocAbortationByProfile"
                                          parentAutocomplete="profile" fieldColSpan="3" horizontalFill="true"
                                          label="Тип аборта"/>
                    </msh:row>
                ...
                <msh:row>
                    <td class="label" title="Поиск по промежутку  (antibio)" colspan="1"><label for="antibioName"
                                                                                                id="tantibioLabel">Периоперационная
                        антибиотикопрофилактика?</label></td>
                ...
                <msh:row>
                    <msh:autoComplete property="classWound" label="Класс раны" fieldColSpan="3" horizontalFill="true"
                                      vocName="vocClassWound"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete property="antibioticDrug" label="Препарат" fieldColSpan="3" horizontalFill="true"
                                      vocName="vocAntibioticDrug"/>
                </msh:row>
                <msh:row>
                    <msh:textField property="dose" label="Доза"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete property="methodsDrugAdm" label="Путь введения" fieldColSpan="3"
                                      horizontalFill="true" vocName="vocMethodsDrugAdm"/>
                </msh:row>
                <msh:row>
                ...
                <msh:ifNotInRole roles="/Policy/Mis/MedCase/Stac/Ssl/ShortEnter">
                    <msh:row>
                        <msh:textArea rows="6" hideLabel="false" property="operationText" viewOnlyField="false"
                                      fieldColSpan="3" label="Протокол операции"/>
                    </msh:row>
                    <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete horizontalFill="true" property="aspect" label="Показания"
                                      vocName="vocHospitalAspect"/>
                    <msh:autoComplete horizontalFill="true" vocName="vocOperationTechnology" property="technology"
                                      label="С испол. ВМТ"/>
                </msh:row>
                ...
                <msh:ifNotInRole roles="/Policy/Mis/MedCase/Stac/Ssl/ShortEnter">
                    ...
                    <msh:row>
                        <ecom:oneToManyOneAutocomplete colSpan="3" label="Ассистенты" property="surgeonFunctions"
                                                       vocName="workFunctionIsSurgical"/>
                    </msh:row>
                    <msh:row>
                        <msh:autoComplete property="operatingNurse" label="Опер. медсестра" fieldColSpan="3"
                                          horizontalFill="true" vocName="workFunctionIsInstrumentNurse"/>
                    </msh:row>
                </msh:ifNotInRole>
                ...
                <msh:ifFormTypeIsCreate formName="stac_surOperationForm">
                    ...
                    <msh:row>
                        <msh:autoComplete property="isAnesthesia" label="Анестезия проводилась?" horizontalFill="true"
                                          vocName="vocYesNo" fieldColSpan="3"/>
                    </msh:row>
                    <msh:row>
                        <msh:autoComplete property="anesthesia" label="Метод" horizontalFill="true"
                                          vocName="vocAnesthesiaMethod" fieldColSpan="3"/>
                    </msh:row>
                    <msh:row>
                        <msh:autoComplete property="anesthesiaService" label="Услуга" horizontalFill="true"
                                          vocName="medServiceAnesthesia" fieldColSpan="3"/>
                    </msh:row>
                    <msh:row>
                        <msh:autoComplete property="anesthesiaType" label="Вид" horizontalFill="true"
                                          vocName="vocAnesthesia" fieldColSpan="3"/>
                    </msh:row>
                    <msh:row>
                        <msh:textField property="anesthesiaDuration" label="Длительность (мин)" fieldColSpan="3"/>
                    </msh:row>
                    <msh:row>
                        <msh:autoComplete property="anaesthetist" label="Анестезиолог" vocName="workFunction"
                ...
                <msh:ifNotInRole roles="/Policy/Mis/MedCase/Stac/Ssl/SurOper/HideCheckBox">
                    ...
                    <msh:row>
                        <msh:textArea hideLabel="false" property="histologicalStudy" viewOnlyField="false"
                                      label="Гистол. исследование" fieldColSpan="3" horizontalFill="true" rows="6"/>
                    </msh:row>
                    <msh:row>
                        <msh:ifFormTypeIsNotView formName="stac_surOperationForm">
                            <td colspan="4" align="center">
                                <input type="button" value="Шаблон"
                                       onClick="showHistologicalStudyTempTemplateProtocol()"/>
                                <input type="button" id="changeSizeHistButton" value="Увеличить"
                                       onclick="changeSizeHist()">
                            </td>
                        </msh:ifFormTypeIsNotView>
                    </msh:row>

                    <msh:row>
                        <msh:autoComplete property="idc10After" label="МКБ после операции" fieldColSpan="3"
                                          horizontalFill="true" vocName="vocIdc10"/>
                    </msh:row>
                    <msh:row>
                        <msh:autoComplete property="outcome" label="Исход операции" fieldColSpan="3"
                                          horizontalFill="true" vocName="vocOperationOutcome"/>
                    </msh:row>
                </msh:ifNotInRole>
                <msh:row>
                    <msh:autoComplete property="leftRight" label="Сторона (для парных органов)" fieldColSpan="3"
                                      horizontalFill="true" vocName="vocLeftRight"/>
                </msh:row>
                <msh:row>
            ...
            <div>
                ...
                <div id="note" style="display:none;">
                    <b>Класс I: чистая</b>: неинфицированная послеоперационная рана при отсутствии воспаления, при этом
                    не затрагивались дыхательный,
                    пищеварительный, половой или неинфицированный мочевыводящий тракты. Чистые раны закрываются
                    первичным натяжением и в случае необходимости
                    дренируются с помощью закрытого дренажа.<br>
                    <b>Класс II: условно-чистая («чисто – контаминированная»)</b>: послеоперационная рана, затрагивающая
                    дыхательный, пищеварительный, половой
                    или мочевыводящий тракты в контролируемых условиях и без необычной контаминации.<br>
                    <b>Класс III: контаминированная («загрязненная»)</b>: открытые, свежие, травматические раны. Кроме
                    того, в эту категорию включены операции
                    со значительными нарушениями асептики (например, открытый массаж сердца), или сопровождающиеся
                    выраженной утечкой содержимого
                    желудочно-кишечного тракта, а также операции, при которых наблюдается острое негнойное
                    воспаление.<br>
                    <b>Класс IV: «грязная» (инфицированная)</b>: старые травматические раны с нежизнеспособными тканями,
                    а также послеоперационные раны,
                    в области которых уже имелась инфекция или произошла перфорация кишечника. Подразумевается, что
                    микроорганизмы, способные вызвать ИОХВ,
                ...
                <table>
                    ...
                    <tr>
                        <td class="buttons" colspan="3">
                            <input id="cancelButton" type="button" onclick="this.disabled=true; window.history.back()"
                                   title="Отменить изменения [SHIFT+ESC]" value="Отменить">
                            <input id="submitButton" class="default" type="button" value="Сохранить изменения     "
                                   onclick="this.value='Сохранение изменений ...'; this.disabled=true; save();  return true ;"
                                   title="Сохранить изменения      [CTRL+ENTER]" autocomplete="off"></td>
                    </tr>
                    </tbody>
                </table>
            </msh:ifFormTypeIsNotView>
    ...
    <tiles:put name="side" type="string">
        <msh:ifFormTypeIsView formName="stac_surOperationForm">
            <msh:sideMenu title="Хир. операция">
                <msh:sideLink key="ALT+2" params="id" action="/entityParentEdit-stac_surOperation" name="Изменить"
                              roles="/Policy/Mis/MedCase/Stac/Ssl/SurOper/Edit"/>
                <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id"
                              action="/entityParentDeleteGoSubclassView-stac_surOperation" name="Удалить"
                              roles="/Policy/Mis/MedCase/Stac/Ssl/SurOper/Delete"/>
                <msh:sideLink key="ALT+3" params="id" action="/entityParentListRedirect-stac_surOperation"
                              name="⇧Cписок операций" roles="/Policy/Mis/MedCase/Stac/Ssl/SurOper/View"
                              title="Перейти к списку операций"/>
            </msh:sideMenu>
            ...
            <msh:sideMenu title="Печать">
                <msh:sideLink key="CTRL+2" params="id"
                              action="/print-surgicalOperation.do?m=printSurOperation&s=HospitalPrintService"
                              name="Протокола операции"/>
                <msh:sideLink key="CTRL+3" params="id"
                              action="/print-surgicalOperation2.do?m=printSurOperation&s=HospitalPrintService"
                              name="Протокола операции 2 копии"/>
            </msh:sideMenu>
        </msh:ifFormTypeIsView>
    </tiles:put>
    ...
    <tiles:put name="javascript" type="string">
        <script type="text/javascript">
            ...
            var masAntibioElements = [{
                name: 'classWoundName',
                req: true,
                desc: 'класс раны'
            }, {name: 'antibioticDrugName', req: true, desc: 'препарат'},
                {name: 'dose', req: true, desc: 'доза', check: true}, {name: 'methodsDrugAdm', req: true, check: true},
                {name: 'methodsDrugAdmName', req: true, desc: 'путь введения', check: true}, {
                    name: 'firstDoseTime',
                    req: true,
                    desc: 'первая доза',
                    check: true
                ...
                {name: 'secondDoseTime', req: false, check: true}, {
                    ...
                    req: false,
                    desc: 'класс раны'
                }, {name: 'antibioticDrug', req: true, check: true}];
        ...
        <msh:ifFormTypeIsCreate formName="stac_surOperationForm">
            ...
            <style type="text/css">
                #anesthesiaLabel, #anaesthetistLabel, #isAnesthesiaLabel, #anesthesiaTypeLabel, #anaesthetistLabel, #isAnesthesiaTypeLabel, #anesthesiaDurationLabel, #methodName, #profileName {
                    color: blue;
                }

                #isAnesthesiaName, #anaesthetistName, #anesthesiaName, #anesthesiaDuration, #anesthesiaTypeName, #methodName, #profileName {
