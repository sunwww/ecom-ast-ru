    ...
    <msh:form action="entityParentSaveGoView-mis_lpuGroup.do" defaultField="lpu" guid="10826cd9-7e71-480c-9d53-c96e6805ce24">
      ...
      <msh:panel guid="070b9d1e-c50f-4423-9d72-274f6b1dc045">
              <msh:row guid="a7a62505-2bfe-41b6-a54f-217b970dc0c3">
                <msh:autoComplete property="lpu" vocName="lpu" label="ЛПУ" fieldColSpan="3" guid="67d2a4af-71bc-4a19-8844-4a59b97fabda" horizontalFill="true" />
              </msh:row>
  ...
  <tiles:put name="side" type="string">
    <msh:sideMenu guid="b08ac525-aee5-493c-bd30-a245e7c80200">
      <msh:ifFormTypeIsView formName="mis_lpuGroupForm" guid="24576531-bcea-4103-9c80-fe9e95c4dfaf">
        <msh:sideLink key="ALT+2" roles="/Policy/Mis/MisLpu/Edit" params="id" action="/entityEdit-mis_lpuArea" name="Изменить" guid="dc8c6883-5faf-41b0-b068-296214839e40" />
      </msh:ifFormTypeIsView>
      <hr />
      <msh:ifFormTypeAreViewOrEdit formName="mis_lpuGroupForm" guid="b0b9ca4d-8f54-4f15-87a7-34b467ed10d5">
        <msh:sideLink key="ALT+DEL" roles="/Policy/Mis/MisLpu/Delete" params="id" action="/entityParentDeleteGoParentView-mis_lpuGroup" name="Удалить" confirm="Удалить участок?" guid="d3d19781-f1b0-42b3-a314-f5e6a2b55584" />
