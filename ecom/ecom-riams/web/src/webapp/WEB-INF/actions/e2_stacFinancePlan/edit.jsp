...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    <tiles:put name="title" type="string">
        <ecom:titleTrail mainMenu="Expert2" beginForm="e2_stacFinancePlanForm" guid="fbc3d5c0-2bf8-4584-a23f-1e2389d03646" />
    </tiles:put>
    <tiles:put name="body" type="string">
        <msh:ifFormTypeIsView formName="e2_stacFinancePlanForm">
        </msh:ifFormTypeIsView>
        <msh:form action="/entitySaveGoView-e2_stacFinancePlan.do" defaultField="name" guid="05d29ef5-3f3c-43b5-bc22-e5d5494c5762">
    ...
    <tiles:put name="side" type="string">
        <msh:ifFormTypeIsView formName="e2_stacFinancePlanForm" guid="22417d8b-beb9-42c6-aa27-14f794d73b32">
