...
<tiles:put name='title' type='string'>
    <ecom:titleTrail mainMenu="Config" beginForm="mis_assessmentCardTemplateForm" guid="4399c99f-8801-4a73-b168-c25c23f8b0ba" />
...
YAHOO.widget.CheckTaskNode.prototype.theId = -1 ;
        ...
        function cancel() {
            window.location = "entityView-mis_assessmentCardTemplate.do?id=${param.id}";
        }
        ...
        function save() {
	    	...
	    	TemplateProtocolService.saveParametersByMedServiceByType('assessmentCard',${param.id}, added, removed, 
			    { 
					callback: function() {
					    var url = "entityView-mis_assessmentCardTemplate.do?id=${param.id}" ;
					    window.location = url;
        ...
        <%
        AssessmentCardTemplateEditAction.printNode(out, (CheckNode) request.getAttribute("params"));
     //   out.print(request.getAttribute("params"));
        %>
