...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        <msh:form action="/stac_resultPatient_list.do" defaultField="department" disableFormDataConfirm="true"
                  method="GET">
            <msh:panel>
                ...
                <msh:row styleId="noswod">
                    <td class="label" title="Поиск по показаниям поступления (typeEmergency)" colspan="1"><label
                            for="typeEmergencyName" id="typeEmergencyLabel">Показания:</label></td>
                ...
                <msh:row styleId="noswod">
                    <td class="label" title="Поиск по проведена ли была операция (typeOperation)" colspan="1"><label
                            for="typeOperationName" id="typeOperationLabel">Была ли операция:</label></td>
                    <td onclick="this.childNodes[1].checked='checked';">
                ...
                <msh:row>
                    <td class="label" title="Поиск по дате  (typeDate)" colspan="1"><label for="typeDateName"
                ...
                <msh:row>
                    <td class="label" title="Поиск по пациентам (typePatient)" colspan="1"><label for="typePatientName"
                                                                                                  id="typePatientLabel">Пациенты:</label>
                    </td>
                    <td onclick="this.childNodes[1].checked='checked';">
                ...
                <msh:row>
                    ...
                    <td onclick="this.childNodes[1].checked='checked';" colspan="3">
                        <input type="radio" name="typeView" value="3"> свод по отделениям без учета отд., которые не
                        входят в ОМС
                    </td>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete property="result" fieldColSpan="4" horizontalFill="true"
                                      label="Результат госпитализации" vocName="vocHospitalizationResult"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete property="pigeonHole" fieldColSpan="4" horizontalFill="true"
                                      label="Причина выписки" vocName="vocReasonDischarge"/>
                </msh:row>
                <msh:row>
        ...
        <%
            ...
            String pigeonHole = (String) request.getParameter("pigeonHole");
            ...
            if (date != null && !date.equals("")) {
                ...
                String reasonSql = "";
                if (pigeonHole != null && !"".equals(pigeonHole)) {
        ...
        <msh:section
                title="${infoTypePat} ${infoTypeEmergency} ${infoTypeOperation}. Период с ${param.dateBegin} по ${dateEnd}. ${infoSearch} ${dateInfo}">
            <msh:sectionContent>
...
then -1 else 0 end) as age
    ...
    left join vocreasondischarge vdr on vdr.id=ss.reasondischarge_id
    ...
    ,d.name,d.isNoOmc,pd.name, oml.name,vof.name,vhtS.name,vdr.name
    ${hav} ${addOperation}
    ...
    "/>
                <msh:table name="journal_list" printToExcelButton="Сохранить в excel"
                    ...
                    <msh:tableColumn columnName="Причина выписки" property="18"/>
    ...
    "/>
                <msh:table name="journal_list_swod" printToExcelButton="Сохранить в excel"
                           action="stac_resultPatient_list.do?dateBegin=${param.dateBegin}&dateEnd=${dateEnd}"
