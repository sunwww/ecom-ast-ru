...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        <msh:form action="/entitySaveGoView-e2_vocFondV015.do" defaultField="code" guid="05d29ef5-3f3c-43b5-bc22-e5d5494c5762">
            ...
            <msh:panel>
               ...
               <msh:row>
                   ...
                   <msh:textField property="parent" size="100"/>
            </msh:row><msh:row>
                <msh:textField property="okso" size="100"/>
            </msh:row><msh:row>
        ...
        <msh:ifFormTypeIsView formName="e2_vocFondV015Form">
            <ecom:webQuery name="linkList" nativeSql="select link.id, vp.code||' '||vp.name  from E2FondMedSpecLink link
             left join vocpost vp on vp.code=link.medosworkfunction where medSpec_id=${param.id}"/>
    ...
    <tiles:put name="title" type="string">
        <ecom:titleTrail mainMenu="Expert2" beginForm="e2_vocFondV015Form" guid="fbc3d5c0-2bf8-4584-a23f-1e2389d03646" />
    </tiles:put>
    ...
    <tiles:put name="side" type="string">
        <msh:ifFormTypeIsView formName="e2_vocFondV015Form" guid="22417d8b-beb9-42c6-aa27-14f794d73b32">
            <msh:sideMenu guid="32ef99d6-ea77-41c6-93bb-aeffa8ce9d55">
                <msh:sideLink key="ALT+2" params="id" action="/entityEdit-e2_vocFondV015" name="Изменить" roles="/Policy/E2/Edit" />
