...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="javascript" type="string">
        ...
        <msh:ifFormTypeIsNotView formName="pres_operationPrescriptionForm">
            <script type="text/javascript">
                ...
                intakeSpecialAutocomplete.addOnChangeCallback(function () {
                    updateOperationParent();
                });
    ...
    <tiles:put name="body" type="string">
        <msh:form action="/entityParentSaveGoView-pres_operationPrescription.do" defaultField="id"
            ...
            <msh:panel colsWidth="3">
                ...
                <msh:ifFormTypeIsView formName="pres_operationPrescriptionForm">
                    ...
                    <msh:row>
                        <msh:autoComplete property="medService" label="Исследование" vocName="surgicalOperations"
                                          horizontalFill="true" size="90" viewOnlyField="true"/>
                    </msh:row>
                            ...
                            <tr>
                                <td>
                                    <table id="surgTable">
                                        ...
                                        <msh:row>
                                            <msh:autoComplete property="prescriptCabinet" label="Операционная"
                                                              fieldColSpan="5" vocName="operationRoom" size='20'
                                                              horizontalFill="true"/>
                                        </msh:row>
                                        <msh:row>
                                            <msh:autoComplete property="surgCalDate"
                                                              parentAutocomplete="prescriptCabinet"
                                                              vocName="vocWorkCalendarDayByWorkFunction" label="Дата"
                                                              size="10" fieldColSpan="1"/>
                                            <msh:textField property="planStartTime" label="Начало операции"
                                                           viewOnlyField="true"/>
                                        </msh:row><msh:row>
                                        ...
                                        <msh:row>
                                            <msh:autoComplete property="medService" label="Операция"
                                                              vocName="medServiceOperation" horizontalFill="true"
                                                              size="90" fieldColSpan="5"/>
                                        </msh:row>
                                        <msh:row>
                                            <msh:autoComplete property="anesthesiaType" vocName="vocAnesthesia"
                                                              label="Анестезия" size="100" fieldColSpan="5"
                                                              horizontalFill="true"/>
                                        </msh:row>
                                        <msh:row>
                                            <msh:textArea property="comments" label="Примечание" size="50"
                                                          fieldColSpan="5"/>
                                        </msh:row>
                                        <tr>
                                            <td colspan="10">
                                                <table>
                                                    <tr>
                                                        <td valign="top">
                                                            <table>
                                                                <msh:row>
                                                                    <msh:separator label="Выбор времени операции"
                                                                                   colSpan="4"/>
                                                                </msh:row>
                                                                <msh:row>
        ...
        <msh:ifFormTypeIsView formName="pres_operationPrescriptionForm">
            <msh:sideMenu title="Назначения">
                <msh:sideLink roles="/Policy/Mis/Prescription/ServicePrescription/Edit" params="id"
                              action="/entityParentEdit-pres_operationPrescription" name="Изменить" key="ALT+2"/>
            ...
            <msh:sideMenu title="Показать">
                <msh:sideLink roles="/Policy/Mis/Prescription/ServicePrescription/View" params="id"
                              action="/entityParentListRedirect-pres_operationPrescription"
                              name="К списку назначений на операцию" key="ALT+4"/>
