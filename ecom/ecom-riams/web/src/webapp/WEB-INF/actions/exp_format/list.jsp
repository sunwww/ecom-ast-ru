...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
    ...
    <tiles:put name='side' type='string'>
        <msh:sideMenu>
            ...
            <msh:sideLink key='ALT+N' params="id" action="/entityParentPrepareCreate-exp_format" name="Создать новый формат" />

        </msh:sideMenu>
    </tiles:put>

    <tiles:put name='body' type='string' >
        <msh:table name="list" action="entityParentEdit-exp_format.do" idField="id">
