...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
  ...
  <tiles:put name="body" type="string">
    <!-- 
    	  - Назначение диеты
    	  -->
    <msh:form action="/entityParentSaveGoView-pres_dietPrescription.do" defaultField="id" title="Назначение диеты">
      ...
      <msh:panel colsWidth="3">
        ...
        <msh:ifFormTypeIsView formName="pres_dietPrescriptionForm">
        <msh:row >
        ...
        <mis:canShowPrescriptionFulfilments formName="pres_dietPrescriptionForm">
    <msh:ifFormTypeIsView formName="pres_dietPrescriptionForm">
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail mainMenu="Prescription" beginForm="pres_dietPrescriptionForm" />
  </tiles:put>
  <tiles:put name="side" type="string">
    <msh:ifFormTypeIsView formName="pres_dietPrescriptionForm">
      <msh:sideMenu title="Назначение диеты">
        <msh:sideLink roles="/Policy/Mis/Prescription/DietPrescription/Edit" params="id" action="/entityParentEdit-pres_dietPrescription" name="Изменить" key="ALT+2"/>
        <msh:sideLink  confirm="Удалить?" roles="/Policy/Mis/Prescription/DietPrescription/Delete" params="id" action="/entityParentDelete-pres_dietPrescription" name="Удалить" key="ALT+DEL"/>
      </msh:sideMenu>
      ...
      <msh:sideMenu title="Перейти" >
        <msh:sideLink roles="/Policy/Mis/Prescription/DietPrescription/View" params="id" action="/entityParentListRedirect-pres_dietPrescription" name="К списку назначенных диет" key="ALT+4"/>
