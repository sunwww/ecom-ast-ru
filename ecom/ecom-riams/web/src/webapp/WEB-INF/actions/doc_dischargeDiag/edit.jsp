...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
  ...
  <tiles:put name="body" type="string">
    <msh:form action="/entityParentSaveGoView-doc_dischargeDiag.do" defaultField="diagnosis">
  ...
  <tiles:put name="side" type="string">
    <msh:ifFormTypeIsView formName="doc_dischargeDiagForm">
      <msh:sideMenu>
        <msh:sideLink key="ALT+2" params="id" action="/entityParentEdit-doc_dischargeDiag" name="Изменить" roles="/Policy/Mis/MedCase/Document/Internal/Discharge/Edit" />
        <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id" action="/entityParentDeleteGoSubclassView-doc_dischargeDiag" name="Удалить" roles="/Policy/Mis/MedCase/Document/Internal/Discharge/Delete" />
      </msh:sideMenu>
