...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail mainMenu="Patient" beginForm="${form}" title="Список суицидов пациента"/>
  </tiles:put>
  <tiles:put name="side" type="string">
      <msh:sideMenu title="Перейти" guid="46a542d6-da04-4268-bb9a-5ebddf3baea2">
        ...
        <msh:sideLink styleId="selected_menu" action="/entityParentList-psych_suicide${addParam}" name="Список суицидов пациента" params="id" roles="/Policy/Mis/Psychiatry/CareCard/Suicide/View"/>
      </msh:sideMenu>
  </tiles:put>
  <tiles:put name="body" type="string">
  	...
  	from Suicide s
  	left join PsychiatricCareCard pcc on pcc.id=s.careCard_id   	where ${queryDop}	"/>
