		...
		<script type="text/javascript">
            ...
            function step6() {
                ...
                $('rowStep7Total').innerHTML = "Запись: на <b>"
                    ...
                    +"<button id='btnRecord' onclick=\"showchooseWayOfRecord('"
                    +patInfo+"','"+idPat+"','"+spTime+"','"+spFunc+"','"
                    +spSpec+"','"+spDay+"','"
                    + $('serviceStream').value + "'," + true+")\">Записать</button>" ;
            ...
            function record(aPatInfo,aPat,aFunc,aSpec,aDay,aTime,aServiceStream,preWayOfRecord) {
                ...
                var servStream = $('serviceStream').value ;
                //alert(servStream) ;
                WorkCalendarService.preRecordByPatient(
                    aPatInfo,aPat,func[0],spec[0],day[1],time[1],
                    servStream,$('phonePatient').value,$('service').value,preWayOfRecord,
                    {
                        callback: function(aResult) {
                            //alert(aResult) ;
                            var d=spDay.split('#') ;
