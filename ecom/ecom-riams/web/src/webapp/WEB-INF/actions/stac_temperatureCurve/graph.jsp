    ...
    <tiles:put name='side' type='string'>
        <msh:sideMenu title="Добавить">
            <msh:sideLink roles="/Policy/Mis/MedCase/Stac/Ssl/TemperatureCurve/Create" name="Температурный лист"
                          params="id" action="/entityParentPrepareCreate-stac_temperatureCurve"
                          title="Добавить параметр"/>
        </msh:sideMenu>
        <msh:sideMenu title="Просмотр">
            <msh:sideLink name="Список параметров" action="/entityParentList-stac_temperatureCurve"
                          title="Показать все температурные параметры" params="id"/>
        </msh:sideMenu>
        <msh:sideMenu title="Печать">
            <msh:sideLink params="id" action="/js-stac_temperatureCurve-printgraph" name="Печать"
                          title="температурного листа"/>
        </msh:sideMenu>
    </tiles:put>
