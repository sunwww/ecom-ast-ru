...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        <msh:form action="/poly_ticketsByNonredidentPatientList.do" defaultField="department"
            ...
            <msh:panel>
                ...
                <msh:row>
                    <td class="label" title="Поиск по пациентам (typePatient)" colspan="1"><label for="typeDurationName"
                                                                                                  id="typeDurationLabel">Длительность:</label>
                    </td>
                ...
                <msh:row>
                    <td class="label" title="Поиск по пациентам (typePatientIs)" colspan="1"><label
                            for="typeDurationName" id="typeDurationLabel">Пациенты:</label></td>
                    <td onclick="this.childNodes[1].checked='checked';">
                ...
                <msh:row>
                    <td class="label" title="Поиск по пациентов (typeDischargePatientIs)" colspan="1"><label
                            for="typeDurationName" id="typeDurationLabel">Пациенты:</label></td>
                ...
                <msh:row>
                    <msh:autoComplete property="department" horizontalFill="true" label="Отделение" vocName="lpu"
                                      fieldColSpan="7"/>
                </msh:row>
                <msh:row>
        ...
        <msh:section
                title="${infoTypePat} ${infoTypeEmergency} ${infoTypeDuration}. Период с ${param.dateBegin} по ${dateEnd}. ${infoSearch}">
...
order by dep.name,vss.name,pat.lastname,pat.firstname,pat.middlename
        ...
        <msh:section
                title="По безполисным по состоящим или направленным в отделение по ОМС+ДРУГИМ. ${infoTypePat} ${infoTypeEmergency} ${infoTypeDuration}. Период с ${param.dateBegin} по ${dateEnd}. ${infoSearch}">
...
order by dep.name,vss.name
    ...
    "/>
                <msh:table name="journal_list_swod"
                           action="stac_receivedWithoutPolicy_list.do?dateBegin=${param.dateBegin}&dateEnd=${param.dateEnd}&typeDuration=${typeDuration}&typePatient=${typePatient}&typePatientIs=${typePatientIs}&typeEmergency=${typeEmergency}&typeDischargePatientIs=${typeDischargePatientIs}&typeView=1"
