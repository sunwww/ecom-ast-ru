...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail beginForm="mis_patientForm" mainMenu="Patient" title="Список всех случаев лечения в стационаре" guid="7c2f862e-0345-431a-a391-39b33538ad1b" />
  </tiles:put>
  <tiles:put name="side" type="string" />
  <tiles:put name="body" type="string">
    <msh:table name="list" action="entityView-stac_ssl.do" idField="id" guid="d579127c-69a0-4eca-b3e3-950381d1585c">
  ...
  <tiles:put name="side" type="string">
    <msh:sideMenu title="Добавить" guid="6372e109-9e1b-49dc-840b-9b38f524efeb">
      <msh:sideLink params="id" action="/entityParentPrepareCreate-stac_ssl" name="Новый случай лечения в стационаре" title="Добавить случай стационарного лечения" guid="436bbb7b-497c-4b10-ba0e-c5601675a713" />
    </msh:sideMenu>
