...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="title" type="string">
        <ecom:titleTrail beginForm="mis_patientForm" mainMenu="Patient"
                         title="Список всех случаев лечения в стационаре"/>
    </tiles:put>
    ...
    <tiles:put name="side" type="string">
        <msh:sideMenu title="Добавить">
            <msh:sideLink params="id" action="/entityParentPrepareCreate-stac_ssl"
                          name="Новый случай лечения в стационаре" title="Добавить случай стационарного лечения"/>
        </msh:sideMenu>
