...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        <msh:form action="/entitySaveGoView-pres_prescription.do" defaultField="hello">
            ...
            <msh:panel>
                ...
                <msh:row>
                    <msh:autoComplete vocName="vocPrescriptCancelReason" property="cancelReason" label="Причина"
                ...
                <msh:row>
                    <msh:autoComplete vocName="vocPrescriptFulfilState" property="fulfilmentState"
                                      label="Состояние назначения" fieldColSpan="4" horizontalFill="true"/>
                </msh:row>
    ...
    <tiles:put name="side" type="string">
        <msh:sideMenu title="Назначения">
            <msh:sideLink roles="/Policy/Mis/Prescription/View" params="id" action="/entityList-pres_prescription"
                          name="К сводному списку назначений"/>
            <msh:sideLink roles="/Policy/Mis/Prescription/Edit" key="ALT+2" params="id"
                          action="/entityEdit-pres_prescription" name="Изменить"/>
            <msh:sideLink roles="/Policy/Mis/Prescription/Delete" key="ALT+DEL" confirm="Удалить?" params="id"
                          action="/entityParentDeleteGoSubclassView-pres_prescription" name="Удалить"/>
        </msh:sideMenu>
        <msh:sideMenu title="Добавить">
            <msh:sideLink roles="/Policy/Mis/Prescription/PrescriptionFulfilment/Create" params="id"
                          action="/entityParentPrepareCreate-pres_prescriptionFulfilment" name="Исполнение назначения "
                          title="Добавить исполнение назначения"/>
        </msh:sideMenu>
