...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
    ...
    <tiles:put name='title' type='string'>
        <msh:title mainMenu="Disability">Список ВК по госпитализации</msh:title>
    </tiles:put>
    ...
    <tiles:put name='body' type='string'>
	    <msh:section title="Список ВК по госпитализации">
	...
	from MedCase slo1
	left join MedCase sloAll on slo1.parent_id=sloAll.parent_id and sloAll.dtype='DepartmentMedCase'
	left join ClinicExpertCard cec on sloAll.id=cec.medCase_id
