...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        <msh:form action="/entityParentSaveGoParentView-e2_v010Link.do" defaultField="medosHospResult" guid="05d29ef5-3f3c-43b5-bc22-e5d5494c5762">
    ...
    <tiles:put name="side" type="string">
        <msh:ifFormTypeIsView formName="e2_v010LinkForm" guid="22417d8b-beb9-42c6-aa27-14f794d73b32">
