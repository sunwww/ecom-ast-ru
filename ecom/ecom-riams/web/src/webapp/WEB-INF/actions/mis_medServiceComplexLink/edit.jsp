...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
  ...
  <tiles:put name="side" type="string">
    <msh:sideMenu title="Связь с комплексной услугой">
      <msh:ifFormTypeIsView formName="mis_medServiceComplexLinkForm">
      ...
      <msh:ifFormTypeAreViewOrEdit formName="mis_medServiceComplexLinkForm">
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail mainMenu="Voc" beginForm="mis_medServiceComplexLinkForm" />
  </tiles:put>
