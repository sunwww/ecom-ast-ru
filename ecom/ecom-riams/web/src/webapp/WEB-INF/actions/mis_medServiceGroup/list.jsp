...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
  ...
  <tiles:put name="body" type="string">
    <msh:table name="list" action="entityParentView-mis_medServiceGroup.do" idField="id">
  ...
  <tiles:put name="side" type="string">
    <msh:sideMenu title="Добавить">
      <msh:sideLink params="" action="/entityPrepareCreate-mis_medServiceGroup" name="Создать" title="Создать" roles="/Policy/Mis/MedService/Create" />
