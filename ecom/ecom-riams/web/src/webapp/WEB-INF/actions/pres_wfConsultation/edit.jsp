        ...
        <tiles:put name="side" type="string">
            <msh:ifFormTypeIsView formName="pres_wfConsultationForm" guid="e20545-4285-a21c-3bb9b4569efc">
                <msh:sideMenu guid="9ec15353-1f35-4c18-b99d-e2b63ecc60c9" title="Конcультация специалиста">
                    ...
                    <msh:sideLink roles="/Policy/Mis/Prescription/ServicePrescription/Edit" params="" action="/javascript:showchooseCnslReasonWf(${param.id})" name="Отменить" guid="ca5sui7r-9239-47e3-aec4-995462584" key="ALT+2"/>
