...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        <tiles:put name="side" type="string">
            <msh:ifFormTypeIsView formName="pres_wfConsultationForm">
                <msh:sideMenu title="Конcультация специалиста">
                    <msh:sideLink key="ALT+2" params="id" action="/entityParentEdit-pres_wfConsultation" name="Изменить"
                                  roles="/Policy/Mis/Prescription/ServicePrescription/Edit"/>
                    <tags:chooseCnslReasonWf name="chooseCnslReasonWf" voc="vocWfConsultationCancelReason"
                                             title="консультацию"/>
                    <msh:sideLink roles="/Policy/Mis/Prescription/ServicePrescription/Edit" params=""
                                  action="/javascript:showchooseCnslReasonWf(${param.id})" name="Отменить" key="ALT+2"/>
                    <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id"
                                  action="/entityParentDelete-pres_wfConsultation" name="Удалить"
                                  roles="/Policy/Mis/Prescription/ServicePrescription/Delete"/>
                </msh:sideMenu>
                <msh:sideMenu title="Перейти">
                    <msh:sideLink roles="/Policy/Mis/Prescription/DietPrescription/View" params="id"
                                  action="/entityParentListRedirect-pres_wfConsultation" name="К списку консультаций"
                                  key="ALT+4"/>
        ...
        <msh:form action="/entityParentSaveGoSubclassView-pres_wfConsultation.do" defaultField="">
            ...
            <msh:panel>
                <msh:row>
                    <msh:autoComplete property="vocConsultingType" label="Тип консультации" horizontalFill="true"
                                      vocName="vocConsultingType" fieldColSpan="3" size="150"/>
                </msh:row>
                <msh:ifFormTypeIsCreate formName="pres_wfConsultationForm">
                    <msh:row>
                        <msh:autoComplete label="Направлен к" property="prescriptCabinet" vocName="workFunctionCons"
                ...
                <msh:ifFormTypeAreViewOrEdit formName="pres_wfConsultationForm">
                    <msh:row>
                        <msh:autoComplete label="Направлен к" property="prescriptCabinet" vocName="workFunctionCons"
                                          viewOnlyField="true" horizontalFill="true" fieldColSpan="3"/>
                    </msh:row>
                ...
                <msh:row>
                    ...
                    <msh:autoComplete label="Пользователь" property="intakeSpecial" vocName="workFunction"
                                      viewOnlyField="true" horizontalFill="true" fieldColSpan="3" size="150"/>
                </msh:row>
