...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        -->
        <msh:form action="/entityParentSaveGoView-stac_sslAdmissionShort.do" defaultField="statCardNumber"
            ...
            <msh:panel>
                ...
                <msh:row>
                    ...
                    <msh:autoComplete vocName="vocHospType" size="35" property="hospType" label="Тип тек. стационара"
                ...
                <msh:row>
                    <msh:autoComplete property="kinsman" label="Представитель (иног.)"
                                      parentId="stac_sslAdmissionShortForm.patient" vocName="kinsmanBySMO"
                ...
                <msh:row>
                    <msh:autoComplete vocName="vocHospType" property="sourceHospType" label="Тип направившего ЛПУ"
                                      fieldColSpan="1" horizontalFill="true"/>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete property="orderMkb" label="Код МКБ направителя" vocName="vocIdc10"
                                      horizontalFill="true" fieldColSpan="3"/>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete showId="false" vocName="vocOmcFrm" hideLabel="false" property="orderType"
                                      viewOnlyField="false" horizontalFill="true" fieldColSpan="3"/>
                </msh:row>
                <msh:row>
                ...
                <msh:ifFormTypeIsCreate formName="stac_sslAdmissionShortForm">
                    <msh:row>
                        <msh:autoComplete parentId="stac_sslAdmissionShortForm.patient" property="attachedPolicies"
                                          label="Прик.полис ОМС" horizontalFill="true" fieldColSpan="3"
                                          vocName="omcPolicyByPatient"/>
                    </msh:row>
                    <msh:row>
                        <msh:autoComplete parentId="stac_sslAdmissionShortForm.patient" property="attachedPolicyDmc"
                ...
                <msh:submitCancelButtonsRow colSpan="4" labelSave="Сохранить изменения" labelCreating="Создание"
