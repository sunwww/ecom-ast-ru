...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    <tiles:put name="body" type="string">
        <msh:form action="/entitySaveGoView-stac_planOphtHospital.do" defaultField="patientName" editRoles="/Policy/Mis/MedCase/Stac/Ssl/Planning/Opht/Edit" createRoles="/Policy/Mis/MedCase/Stac/Ssl/Planning/Opht/Create">
        <msh:panel>
    ...
    <tiles:put name="title" type="string">
        <ecom:titleTrail mainMenu="Patient" beginForm="stac_planOphtHospitalForm" />
    </tiles:put>
    <tiles:put name="side" type="string">
        <msh:ifFormTypeIsView formName="stac_planOphtHospitalForm">
            <msh:sideMenu title="Планирование госпитализаций">
                <msh:sideLink key="ALT+2" params="id" action="/entityEdit-stac_planOphtHospital" name="Изменить" roles="/Policy/Mis/MedCase/Stac/Ssl/Planning/Opht/Edit" />
                <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id" action="/entityParentDeleteGoParentView-stac_planOphtHospital" name="Удалить" roles="/Policy/Mis/MedCase/Stac/Ssl/Planning/Opht/Delete" />
            </msh:sideMenu>
            <msh:sideMenu title="Перейти">
                <msh:sideLink key="ALT+2" action="/javascript:goVisit()" name="⇧ К визиту" />
            </msh:sideMenu>
