...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
    ...
    <tiles:put name="title" type="string">
        <ecom:titleTrail beginForm="mis_patientForm" mainMenu="Patient" title="Список всех планирований введения ангиогенеза" />
    </tiles:put>
    <tiles:put name="side" type="string">
        <msh:sideMenu title="Добавить">
            <msh:sideLink params="id" action="/entityParentPrepareCreate-stac_planOphtHospital" name="Добавить планирование введения ангиогенеза" title="Добавить планирование введения ангиогенеза" roles="/Policy/Mis/MedCase/Stac/Ssl/Planning/Opht/Create" key="ALT+N" />
        </msh:sideMenu>
    </tiles:put>
...
where pat.id='${param.id}' and e.id is not null"/>
        <msh:table name="list" action="entityParentView-stac_planOphtHospital.do" idField="1">
