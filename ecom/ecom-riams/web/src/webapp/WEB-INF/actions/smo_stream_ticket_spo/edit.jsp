...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
  ...
  <tiles:put name="body" type="string">
    ...
    <msh:form guid="formHello" action="entityParentSaveGoView-smo_stream_ticket_spo.do"  defaultField="dateStart" > 
      ...
      <msh:row>
        ...
        <msh:ifInRole roles="/Policy/Mis/MisLpu/Psychiatry">
        	<msh:ifFormTypeIsView formName="smo_stream_ticket_spoForm">
        ...
        <msh:row>
        	...
        	parentId="smo_stream_ticket_spoForm.medcard" vocName="kinsmanByTicket" horizontalFill="true" fieldColSpan="3"/>
        </msh:row>
        ...
        <msh:row>
          <msh:autoComplete viewAction="entityParentView-smo_spo.do" property="parent" 
          	...
          	horizontalFill="true" vocName="vocOpenedSpoByPatient" parentId="smo_stream_ticket_spoForm.patient" />
        </msh:row>
        ...
        <msh:ifInRole roles="/Policy/Mis/MedCase/Stac/Ssl/ShortEnter">
        	<msh:ifFormTypeIsCreate formName="smo_stream_ticket_spoForm">
	        <msh:row>
        ...
        <msh:row>
        <msh:ifFormTypeIsNotView formName="smo_stream_ticket_spoForm">
       ...
       <msh:separator label="Мед.услуги" colSpan="7"/>
        ...
        <msh:ifFormTypeAreViewOrEdit formName="smo_stream_ticket_spoForm">
  ...
  <tiles:put name="side" type="string">
    ...
    <msh:ifFormTypeIsView formName="smo_stream_ticket_spoForm" guid="8f-4d80-856b-ce3095ca1d">
      <msh:sideMenu guid="e6c81315-888f-4d80-856b-ce3095ca1d55" title="Талон" >
        <msh:sideLink roles="/Policy/Poly/Ticket/Edit" key="ALT+2" params="id" action="/entityEdit-smo_stream_ticket_spo" name="Изменить" guid="89585df8-aadb-4d59-abd9-c0d16a6170a9" title="Изменить талон" />
		...
		name="Закрыть СПО" title="Закрыть СПО" confirm="Закрыть СПО?" 
			...
			<msh:sideLink roles="/Policy/Poly/Ticket/CreateTalk" key="ALT+4" params="id" action="/js-smo_stream_ticket_spo-addTalk" name="Беседа с родственниками" guid="661fe852-e096-410a-9fab-86d8e75db177" title="Беседа с родственниками" />
        <msh:sideLink roles="/Policy/Poly/Ticket/Edit,/Policy/Poly/Ticket/TalkDelete,/Policy/Mis/MisLpu/Psychiatry" key="ALT+4" params="id" action="/js-smo_stream_ticket_spo-doNotAddTalk" name="Сделать обычным посещением" guid="661fe852-e096-410a-9fab-86d8e75db177" title="Беседа с родственниками" />
        
        <msh:ifFormTypeAreViewOrEdit formName="smo_stream_ticket_spoForm" guid="7f581b0a-a8b3-4d57-9cff-6dc6db1c85e3">
          <msh:sideLink roles="/Policy/Poly/Ticket/Delete" key="ALT+DEL" params="id" action="/entityParentDeleteGoParentView-smo_stream_ticket_spo" name="Удалить" confirm="Вы действительно хотите удалить талон?" guid="8b9de89f-3b99-414e-b4af-778ccbb70edf" title="Удалить талон" />
        </msh:ifFormTypeAreViewOrEdit>
      </msh:sideMenu>
      <msh:sideMenu title="Добавить" guid="3d94cf79-f341-469e-863e-5e28bd16aabe">
        ...
        <msh:sideLink roles="/Policy/Poly/Ticket/Create" key="CTRL+4" 
         action="/javascript:window.location='entityParentPrepareCreate-smo_stream_ticket_spo.do?id='+$('medcard').value" name="Талон на пациента"
         title="Добавить талон" />
        <msh:sideLink roles="/Policy/Poly/Ticket/Create"
         action="/javascript:window.location='entityParentPrepareCreate-smo_stream_ticket_spo.do?id='+$('medcard').value+'&prevTicket='+$('id').value" name="Талон на основе текущего"
  ...
  <tiles:put name="title" type="string">
    <ecom:titleTrail mainMenu="Medcard" beginForm="smo_stream_ticket_spoForm" guid="5c4f3682-e66b-4e0d-b448-4e6a2961a943" />
  </tiles:put>
  <tiles:put name="javascript" type="string">
    ...
    function infoDiagByMedcard(d) {
    	var m = document.forms[0].medcard ;
  	  getDefinition("js-smo_stream_ticket_spo-infoDiagByMedcard.do?id="+m.value, null); 
    }    
    </script>
  	<msh:ifInRole roles="/Policy/Poly/Ticket/IsDoctorEdit">
  <msh:ifFormTypeIsCreate formName="smo_stream_ticket_spoForm">
		...
		TicketService.isEditCheck($('id').value, $('workFunctionExecute').value,
			{
				callback: function(aResult) {
					if (+aResult.substring(0,1)==0) {
						...
						window.location.href= "entityParentView-smo_stream_ticket_spo.do?id=${param.id}"; 
					}
				}
			}
		);
