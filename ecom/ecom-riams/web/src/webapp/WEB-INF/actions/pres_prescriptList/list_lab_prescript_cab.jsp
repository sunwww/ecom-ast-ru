...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        %>
        <msh:form action="/pres_journal_prescript_cab_lab.do" defaultField="beginDate" disableFormDataConfirm="true"
                  method="GET">
            <msh:panel>
                <msh:row>
                ...
                <msh:row>
                    <td class="label" title="Кабинет (typeCabinet)" colspan="1"><label for="typeCabinetName"
                                                                                       id="typeCabinetLabel">Кабинет:</label>
                    </td>
                ...
                <msh:row>
                    <td class="label" title="Искать по дате (typeDate)"><label for="typeDateName" id="typeDateLabel">Искать
                        по дате:</label></td>
                ...
                <msh:row>
                    <td class="label" title="Этап исследования (typeResult)"><label for="typeResultName"
                                                                                    id="typeResultLabel">Этап
                        выполнения:</label></td>
                    <td onclick="this.childNodes[1].checked='checked';checkfrm();" colspan="1">
                ...
                <msh:row>
                    <msh:autoComplete property="department" fieldColSpan="4" horizontalFill="true" label="Отделение"
                                      vocName="lpu"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete property="prescriptType" fieldColSpan="4" horizontalFill="true"
                                      label="Тип назначения" vocName="vocPrescriptType"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete parentId="LABSURVEY" property="serviceSubType" fieldColSpan="4"
  ...
  , case when (ms.isaskstatuswomen or ms.isaskbiotype or ms.isaskhwa) and p.noteForLab<>'' then p.noteForLab else null end as f26_note
    from prescription p
    ...
    "/>
            ...
            <msh:sectionContent>
                <msh:table name="list" action="javascript:void(0)" idField="1" styleRow="19"
                    ...
                    <msh:tableButton property="21" hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratory"
                                     buttonFunction="hideRow(this); showBioIntakeCancel" buttonName="Брак"
                                     buttonShortName="Брак"/>
                    <msh:tableButton property="14" hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratory"
                                     buttonFunction="hideRow(this); checkLabAnalyzed" buttonName="Анализ"
                                     buttonShortName="Анализ"/>
                    <msh:tableButton property="18" hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratory"
                                     buttonFunction="hideRow(this); goBioService"
                                     buttonName="Подтвердить выполнение результата и ввести результат"
                                     buttonShortName="Ан.+Рез."/>
                    <msh:tableButton property="25" hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratoryPCR"
                                     buttonFunction="hideRow(this); goBioService"
                                     buttonName="Подтвердить выполнение результата и ввести результат"
                                     buttonShortName="Рез. ПЦР"/>
                    <msh:tableButton property="15" hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratory"
                                     buttonFunction="hideRow(this); goBioService" buttonName="Ввести результат"
                                     buttonShortName="Рез."/>
                    <msh:tableButton property="16" hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratory"
                                     buttonFunction="hideRow(this); checkLabControl"
                                     buttonName="Результат заведен правильно" buttonShortName="Подт."/>
                    <msh:tableColumn columnName="#" property="sn"/>
                    <msh:tableColumn columnName="Код назн." property="4"/>
                    <msh:tableColumn columnName="Номер ПЦР" property="24"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratoryPCR"/>
                    <msh:tableButton property="13" buttonFunction="getDefinition"
                                     buttonName="Просмотр данных о госпитализации" buttonShortName="ИБ"
                                     hideIfEmpty="true" role="/Policy/Mis/Patient/View"/>
                    <msh:tableButton property="12" buttonFunction="getDefinition"
                                     buttonName="Просмотр данных о лабораторных назначениях" buttonShortName="ЛН"
                                     hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratory"/>
                    <msh:tableButton property="23" buttonFunction="getDefinition" buttonName="Просмотр динамики анализа"
                                     buttonShortName="Дин" hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratory"/>
                    <msh:tableColumn columnName="ИБ" property="3"/>
                    <msh:tableButton property="26" buttonFunction="showNote" buttonName="Просмотр примечания"
                                     buttonShortName="Прим" hideIfEmpty="true"/>
                    ...
                    <msh:tableButton property="20" hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratory"
                                     buttonFunction="showLabDoctorDirMedService" buttonName="Добавить анализ"
                                     buttonShortName="Доб.А"/>
                    <msh:tableButton property="21" hideIfEmpty="true"
                                     role="/Policy/Mis/Journal/Prescription/LabSurvey/DoctorLaboratory"
                                     buttonFunction="makePatology" buttonName="Критическая патология"
                                     buttonShortName="Критическая патология"/>
    ...
    <tiles:put name="javascript" type="string">
        ...
        <script type="text/javascript">
            ...
            function showNote(note) {
                showToastMessage(note, null, true, false, 6000);
            }
            ...
            prescriptTypeAutocomplete.addOnChangeCallback(function () {
                checkfrm()
            });
