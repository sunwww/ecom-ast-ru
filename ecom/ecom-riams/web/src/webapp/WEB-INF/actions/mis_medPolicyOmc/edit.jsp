...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name='body' type='string'>
        ...
        <msh:form action="entityParentSaveGoParentView-mis_medPolicyOmc.do" defaultField="typeName">
            ...
            <msh:panel colsWidth="5%,15%,5%,15%,5%">
                ...
                <msh:row>
                    <msh:autoComplete vocName="vocMedPolicyOmc" property="type" label="Тип полиса" horizontalFill="true"
                                      fieldColSpan="5"/>
                </msh:row>
                <msh:row>
                    <msh:textField property="commonNumber" label="Единый номер (RZ)" fieldColSpan="5"
                                   horizontalFill="true"/>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete vocName="vocInsuranceCompany" property="company" label="Страховая&nbsp;компания"
                                      size='50' horizontalFill="true" fieldColSpan="5"/>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    ...
                    <msh:autoComplete property="confirmationType" label="Тип" vocName="vocPolicyConfirmationType"
                                      horizontalFill="true"/>
                </msh:row>
            ...
            <msh:section>
                <div id='changeType' style='display:none'>
                    ...
                    <msh:autoComplete label="Новый тип" vocName="vocMedPolicy" property="changePolicyType"
                                      fieldColSpan="10" size="50"/>
    ...
    <tiles:put name='side' type='string'>
        <msh:sideMenu>
            ...
            <msh:ifFormTypeIsView formName="mis_medPolicyOmcForm">
                <msh:sideLink roles="/Policy/Mis/MedPolicy/Omc/Edit" key="ALT+2" params="id"
                              action="/entityParentEdit-mis_medPolicyOmc" name="Изменить"/>
            </msh:ifFormTypeIsView>

            <hr/>
            <msh:ifFormTypeAreViewOrEdit formName="mis_medPolicyOmcForm">
                <msh:sideLink roles="/Policy/Mis/MedPolicy/Omc/Delete" key='ALT+DEL' params="id"
                              action="/entityParentDeleteGoParentView-mis_medPolicyOmc" name="Удалить"
                ...
                <msh:ifFormTypeIsNotView formName="mis_medPolicyOmcForm">
                    <msh:sideLink roles="/Policy/Mis/MedPolicy/Omc/Edit"
                                  action="/javascript:{$('changeType').style.display='block';}"
                                  name="Изменить тип полиса"/>
                    ...
                    PatientService.getCodeByMedPolicyOmc($('type').value, {
                        callback: function (aResult) {
                            if (+aResult == 3) {
                                ...
                                $('series').className = " upperCase required";
                            }
                        }
                    });
                }

                //Если полис - нового образца, то номер заполним ЕНП
                function setNumberIsCommonNumber() {
                    if ($('commonNumber').value && !$('polNumber').value) {
                        $('polNumber').value = $('commonNumber').value;
                        $('series').value = "";
                    }
                }
