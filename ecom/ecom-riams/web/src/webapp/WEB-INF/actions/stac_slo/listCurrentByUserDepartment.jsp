...
(
 ...
 order by patfio
    ...
    "
                         guid="81cbfcaf-6737-4785-bac0-6691c6e6b501" />
          <msh:table name="datelist" viewUrl="stac_journalCurrentByUserDepartment.do?short=Short&" action="stac_journalCurrentByUserDepartment.do?short=Short&" idField="1" guid="be9cacbc-17e8-4a04-8d57-bd2cbbaeba30" cellFunction="true">
            <msh:tableColumn property="sn" columnName="#"/>
...
<!--
lastrelease milamesher 02.03.2018 (#91)
-->