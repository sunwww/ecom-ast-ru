...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
    ...
    String depCode=request.getParameter("id") ;
    	 ...
    	 if (depCode==null || depCode=="") {
	    	...
	    	%>
	    	<ecom:webQuery isReportBase="false"  name="patList" nativeSql="select dep.id,dep.name,count(pw.id)
        ...
        %>
	    	...
	    	%>
	    	<ecom:webQuery isReportBase="false"  name="patList" nativeSql="select p.lastname,p.firstname,p.middlename,st.code
