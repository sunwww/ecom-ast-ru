...
<tiles:insert page="/WEB-INF/tiles/main${param.s}Layout.jsp" flush="true">
    ...
    "
            ...
            <msh:sectionTitle>
                <form action="print-dirCovid.do" method="post" target="_blank" id="printForm">
                    ...
                    <input type='hidden' name="depName" id="depName" value="">
    ...
    "
                    />
                    <msh:table name="datelist" viewUrl="stac_directionCovidByUserDepartment.do?s=Short&"
                               action="stac_directionCovidByUserDepartment.do" idField="1">
                        <msh:tableColumn property="sn" columnName="#"/>
    ...
    <tiles:put name="javascript" type="string">
        <script type="text/javascript">
            ...
            function print() {
                ...
                if (params.length > 0) {
                    $('info').value = params;
                    $('depName').value = '${departmentInfo}'.replace('ГБУЗ АО "АЛЕКСАНДРО-МАРИИНСКАЯ ОБЛАСТНАЯ КЛИНИЧЕСКАЯ БОЛЬНИЦА " / ','') ;
