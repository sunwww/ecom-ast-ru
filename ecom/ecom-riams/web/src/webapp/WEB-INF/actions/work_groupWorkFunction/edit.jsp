    ...
    <tiles:put name="body" type="string">
            ...
            <msh:panel>
                ...
                <msh:row>
                    <msh:autoComplete viewAction="entityView-voc_workFunction.do" vocName="vocWorkFunction"
                                      property="workFunction" label="Функция" fieldColSpan="3" horizontalFill="true"/>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    <msh:checkBox property="isCreateDIrectionWithoutService"
                                  label="Разрешено создавать направление без указания услуг" fieldColSpan="3"
                                  horizontalFill="true"/>
                </msh:row>
                <msh:row>
                    <msh:checkBox property="isNoViewRemoteUser" label="Запрет на запись удаленными пользователями"
                                  fieldColSpan="3" horizontalFill="true"/>
                </msh:row>
                <msh:row>
        ...
        <msh:ifFormTypeIsView formName="work_groupWorkFunctionForm">
            ...
            <msh:section title="Список сотрудников">
                ...
                <msh:table name="functions" viewUrl="entityShortView-work_personalWorkFunction.do"
                           action="entityParentView-work_personalWorkFunction.do" idField="id">
    ...
    <tiles:put name="side" type="string">
        <msh:ifFormTypeIsView formName="work_groupWorkFunctionForm">
            <msh:sideMenu title="Рабочая функция">
                <msh:sideLink key="ALT+2" params="id" action="/entityEdit-work_groupWorkFunction" name="Изменить"
                              roles="/Policy/Mis/Worker/WorkFunction/Create"/>
                <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id"
                              action="/entityParentDelete-work_groupWorkFunction" name="Удалить"
                              roles="/Policy/Mis/Worker/WorkFunction/Delete"/>
                <msh:sideLink params="id" action="/entityParentPrepareCreate-mis_workFunctionClaimType"
                              name="Привязать к типу заявки" roles="/Policy/Mis/Worker/WorkFunction"/>
            </msh:sideMenu>
