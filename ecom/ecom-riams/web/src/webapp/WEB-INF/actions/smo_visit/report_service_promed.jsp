...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
    ...
    <tiles:put name='title' type='string'>
        <msh:title mainMenu="Poly">Просмотр данных по услугам (ПРОМЕД) </msh:title>
    </tiles:put>
  ...
  <%
	...
	String typePromed =ActionUtil.updateParameter("Form039Action","typePromed","1", request) ;
  ...
  %>
    ...
    <msh:panel>
      ...
      <msh:row>
        ...
        <msh:row>
	        <td class="label" title="Просмотр данных (typePromed)" colspan="1"><label for="typePromedName" id="typePromedLabel">Выгружены в промед:</label></td>
	        <td onclick="this.childNodes[1].checked='checked';">
	        	<input type="radio" name="typePromed" value="1">  да
	        </td>
	        <td onclick="this.childNodes[1].checked='checked';" colspan="2">
    ...
    <%
    	if (request.getParameter("beginDate")!=null && request.getParameter("finishDate")!=null) {
			...
			String typePromedSql ;
			if ("1".equals(typePromed)) {
				typePromedSql = " and smo.promedcode is not null";
			} else if ("2".equals(typePromed)) {
				typePromedSql = " and smo.promedcode is null";
			} else {
				typePromedSql = "";
			}
			request.setAttribute("typePromedSql", typePromedSql);
...
" /> 
  ...
  <tiles:put name="javascript" type="string">
    ...
    checkFieldUpdate('typePromed','${typePromed}',1) ;
