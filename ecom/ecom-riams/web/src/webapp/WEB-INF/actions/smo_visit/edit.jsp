...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        <msh:form action="/entitySaveGoView-smo_visit.do" defaultField="dateStart">
            ...
            <msh:panel>
                <msh:row>
                    <td colspan="4">
                        <div id='medPolicyInformation' style="display: none;" class="errorMessage"></div>
                    </td>
                </msh:row>
      	...
      	where d.medcase_id='${param.id}' AND UPPER(d.dtype)='EXTERNALDOCUMENT'"/>
                            <msh:tableNotEmpty name="documentsByVisitList">
                                <msh:table name="documentsByVisitList"
                                    ...
                                    <msh:tableButton property="4" buttonFunction="showExternalDocument"
                                                     buttonName="Просмотреть документ"
                                                     buttonShortName="Просмотреть документ"/>
                                </msh:table>
                            </msh:tableNotEmpty>
                        </td>
                    ...
                    <msh:row>
                        <msh:textArea property="patientComment" fieldColSpan="4" label="Сообщение пациента при записи"
                                      viewOnlyField="true"/>
                    </msh:row>
                </msh:ifInRole>
                <msh:separator colSpan="4" label="Направлен"/>
                <msh:row>
                    <msh:autoComplete vocName="mainLpu" property="orderLpu" label="Внешний направитель"
                                      horizontalFill="true" fieldColSpan="3" viewOnlyField="true"/>
                </msh:row>
                <msh:row>
                    <msh:textField property="orderDate" label="Дата направления" viewOnlyField="true" labelColSpan="3"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete viewAction="entitySubclassView-work_workFunction.do"
                                      vocName="workFunctionByDirect" property="workFunctionPlan" label="Куда"
                                      fieldColSpan="3" size="50" viewOnlyField="true"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete vocName="vocWorkCalendarDayByWorkFunction" property="datePlan"
                                      label="Направлен на дату" horizontalFill="true"
                                      parentAutocomplete="workFunctionPlan" viewOnlyField="true"/>
                    <msh:autoComplete vocName="vocWorkCalendarTimeWorkCalendarDay" property="timePlan" label="Время"
                                      parentAutocomplete="datePlan" viewOnlyField="true"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete viewAction="entitySubclassView-work_workFunction.do" vocName="workFunction"
                                      property="orderWorkFunction" label="Функция направителя" fieldColSpan="3"
                                      horizontalFill="true" viewOnlyField="true" size="50"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete viewAction="entityParentView-smo_spo.do" property="parent" label="СПО"
                                      fieldColSpan="3" horizontalFill="true" vocName="vocOpenedSpoByPatient"
                                      parentId="smo_visitForm.patient"/>
                ...
                <msh:row>
                    <msh:ifInRole roles="/Policy/Mis/MedCase/Visit/DontEditServiceStream">
                        <msh:autoComplete size="20" showId="false" vocName="vocServiceStream" property="serviceStream"
                                          label="Поток" horizontalFill="true" viewAction="true"/>
                    </msh:ifInRole>
                    <msh:ifNotInRole roles="/Policy/Mis/MedCase/Visit/DontEditServiceStream">
                        <msh:autoComplete size="20" showId="false" vocName="vocServiceStream" property="serviceStream"
                                          label="Поток" horizontalFill="true"/>
                    </msh:ifNotInRole>
                    <msh:autoComplete size="20" showId="false" vocName="vocWorkPlaceType" property="workPlaceType"
                                      label="Место" horizontalFill="true"/>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete property="kinsman" label="Представитель"
                                      ...
                                      parentId="smo_visitForm.patient" vocName="kinsmanBySMO" horizontalFill="true"
                                      fieldColSpan="3"/>
                </msh:row>
                <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete vocName="vocReason" property="visitReason" viewOnlyField="false"
                                      label="Цель визита" fieldColSpan="1" horizontalFill="true"/>
                    <msh:autoComplete vocName="vocDispanseryRegistration" property="dispRegistration"
                                      label="Диспансерный учет" fieldColSpan="1" horizontalFill="true"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete showId="false" vocName="vocVisitResult" property="visitResult"
                                      viewOnlyField="false" label="Результат визита" fieldColSpan="1"
                                      horizontalFill="true"/>
                    <msh:textField property="uet" label="Усл.един.трудоем."/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete vocName="vocHospitalization" labelColSpan="3" property="hospitalization"
                                      label="Посещ. по дан. заболеванию в текущем году" horizontalFill="true"/>
                </msh:row>
                <msh:row>
                    <msh:autoComplete vocName="vocMedCaseDefect" labelColSpan="3" property="medCaseDefect"
                                      label="Дефекты направления" horizontalFill="true"/>
                </msh:row>
                <msh:row>
                    <ecom:oneToManyOneAutocomplete viewAction="entityView-mis_medService.do" label="Мед. услуги"
                                                   property="medServices" vocName="medServiceForSpec" colSpan="5"/>
                </msh:row>
                <msh:ifInRole roles="/Policy/Mis/MisLpu/Ambulance">
                    ...
                    <msh:row>
                        <msh:autoComplete vocName="vocAmbulance" property="ambulance" label="Бригада СП"
                                          horizontalFill="true"/>
                        <msh:autoComplete vocName="vocVisitOutcome" property="visitOutcome" label="Исход СП"
                                          horizontalFill="true"/>
                    </msh:row>
                </msh:ifInRole>
                <msh:row>
                ...
                <msh:row>
                    <msh:autoComplete viewAction="entitySubclassView-work_workFunction.do" vocName="workFunction"
                                      property="workFunctionExecute" label="Функция" fieldColSpan="3"
            ...
            <msh:panel>
                ...
                <msh:ifFormTypeIsNotView formName="smo_visitForm">
                    <msh:row>
                        <td colspan="3" align="right"><input type="button" onclick="preRecord()"
                                                             value="Предварительный прием"></td>
                    </msh:row>
        ...
        <msh:ifFormTypeIsView formName="smo_visitForm">
            <msh:ifInRole roles="/Policy/Mis/MedCase/Diagnosis/View">
      		...
      		having count(diag.id)>0 or count(case when vwf.isNoDiagnosis='1' then vwf.id else null end)>0"
                                   maxResult="1"/>
            ...
            <msh:ifInRole roles="/Policy/Mis/MedCase/Protocol/View">
                <msh:section title="Заключение">
                    ...
                    <msh:table hideTitle="false" disableKeySupport="false" idField="id" name="protocols"
                        ...
                        <msh:tableColumn columnName="Запись" identificator="false" property="record"
                                         cssClass="preCell"/>
            ...
            <msh:ifInRole roles="/Policy/Mis/MedCase/MedService/View">
                <msh:section title="Услуги" createUrl="entityParentPrepareCreate-smo_medService.do?id=${param.id}"
    ...
    <tiles:put name="side" type="string">
        <msh:ifFormTypeIsNotView formName="smo_visitForm">
            <msh:sideMenu title="Визит">
                <msh:sideLink confirm="Вы точно хотите оформить не явку на прием" key="ALT+3" params="id"
                              action="/js-smo_visit-noPatient" name="Оформить не явку на прием"
                              title="Оформить не явку на прием" roles="/Policy/Mis/MedCase/Visit/Edit"/>
                <msh:sideLink action="/javascript:showSimpleService()" name="Добавить простую услугу"
                              title="Добавить простую услугу" roles="/Policy/Mis/MedCase/Visit/Edit"/>
                <msh:sideLink action="/javascript:setPayed()" name="Отметить оплаченным"
                              title="Отметить оплаченным" roles="/Policy/Mis/MedCase/Visit/SetPayed"/>
            ...
            <msh:sideMenu title="Показать">
                ...
                <msh:sideLink styleId="viewShort" action="/javascript:viewOtherExtMedserviceByPatient('.do')"
                              name='Внешние лаб. исследования' title="Просмотр внешних лабораторных данных по пациенту"
                              key="ALT+5" params="" roles="/Policy/Mis/MedCase/Document/External/Medservice/View"/>
        ...
        <msh:ifFormTypeIsView formName="smo_visitForm">
            <msh:sideMenu title="Визит">
                ...
                />
                <msh:sideLink key="ALT+2" params="id" action="/entityEdit-smo_visit" name="Принять пациента"
                              roles="/Policy/Mis/MedCase/Visit/Edit"/>
                <msh:sideLink params="id" action="/entityEdit-smo_direction" name="Редактировать направление"
                              roles="/Policy/Mis/MedCase/Direction/Edit"/>
                <tags:mis_change_lpu service="TicketService" name="CSS" title="Изменить ЛПУ направителя"
                                     roles="/Policy/Mis/MedCase/Direction/Edit"/>
                <msh:sideLink confirm="Вы точно хотите оформить не явку на прием" key="ALT+3" params="id"
                              action="/js-smo_visit-noPatient" name="Оформить не явку на прием"
                              title="Оформить не явку на прием" roles="/Policy/Mis/MedCase/Visit/Edit"/>
                <msh:sideLink params="id" action="/js-smo_visit-closeSpo" name="Закрыть СПО" title="Закрыть СПО"
                              confirm="Закрыть СПО?" key="ALT+4" roles="/Policy/Mis/MedCase/Spo/Close"/>

                <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id"
                              action="/entityParentDeleteGoParentView-smo_visit" name="Удалить"
                              roles="/Policy/Mis/MedCase/Visit/Delete"/>
                <msh:sideLink styleId="viewShort"
                              action="/javascript:getDefinition('js-smo_visit-cost_case.do?short=Short&id=${param.id}','.do')"
            ...
            <msh:sideMenu title="Добавить">
                <msh:sideLink params="id" action="/entityParentPrepareCreate-smo_diagnosis" name="Диагноз"
                              title="Добавить диагноз" roles="/Policy/Mis/MedCase/Diagnosis/Create" key="ALT+5"/>
                <msh:sideLink params="id" action="/entityParentPrepareCreate-vac_vaccination" name="Вакцинацию"
                              title="Добавить вакцинацию" roles="/Policy/Mis/Vaccination/Create" key="ALT+6"/>
                <msh:sideLink params="id" action="/entityParentPrepareCreate-smo_visitProtocol" name="Заключение"
                              title="Добавить протокол" roles="/Policy/Mis/MedCase/Protocol/Create" key="ALT+7"/>
                <msh:sideLink params="id" action="/entityParentPrepareCreate-smo_planHospitalByVisit"
                              name="Предварительную госпитализацию" title="Добавить предварительную госпитализацию"
                              roles="/Policy/Mis/MedCase/Protocol/Create" key="ALT+10"/>
                <msh:sideLink roles="/Policy/Mis/MedCase/Stac/Ssl/Planning/Opht/Create" params=""
                              action="/javascript:createPlanOphtHospital()" name="Планирование введения ангиогенеза"
                              title="Планирование введения ангиогенеза"/>
                <msh:sideLink params="id" action="/pharm_outcome" name="Списание" title="Добавить Списание"
                              roles="/Policy/Mis/Pharmacy/CreateOutcome"/>
                ...
                <msh:sideLink roles="/Policy/Mis/MedCase/Direction/Create" key="CTRL+1"
                              name="Направление к другому специалисту &larr;"
                              action="/javascript:goNewDirectionOther('.do')"
                ...
                <msh:sideLink roles="/Policy/Mis/AssessmentCard/Create" name="Карту оценки"
                              action="/javascript:goCreateAssessmentCard()" title="Карту оценки"/>
            ...
            <msh:sideMenu title="Администрирование">
                ...
                <tags:mis_choiceSpo method="moveVisitOtherSpo" methodGetPatientByPatient="getOpenSpoBySmo"
            ...
            <msh:sideMenu title="Показать">
                <msh:sideLink params="id" action="/entityParentList-vac_vaccination" name="Вакцинации"
                              title="Показать все вакцинации" roles="/Policy/Mis/Vaccination/View"/>
                <msh:sideLink roles="/Policy/Mis/MedCase/MedService/View" name="Услуги" params="id"
                              action="/entityParentList-smo_medService" title="Показать все услуги"/>
                <msh:sideLink styleId="viewShort" action="/javascript:viewExtMedDocumentByPatient('.do')"
                              name='Внеш. мед. документы' title="Просмотр внеш. мед. документов по пациенту" params=""
                              roles="/Policy/Mis/MedCase/Document/External"/>
                <msh:sideLink styleId="viewShort" action="/javascript:viewOtherVisitsByPatient('.do')" name='ВИЗИТЫ'
                              title="Просмотр визитов по пациенту" key="ALT+4" params=""
                              roles="/Policy/Mis/MedCase/Visit/View"/>
                <msh:sideLink styleId="viewShort" action="/javascript:viewOtherDiagnosisByPatient('.do')"
                ...
                <msh:sideLink styleId="viewShort" action="/javascript:viewOtherHospitalMedCase('.do')"
                              name='Госпитализации' title="Просмотр госпитазиций по пациенту" key="ALT+6" params=""
                              roles="/Policy/Mis/MedCase/Stac/Ssl/View"/>
                <msh:sideLink styleId="viewShort" action="/javascript:viewOtherPreHospByPatient('.do')"
                              name='Пред госпитализации' title="Просмотр предварительных госпитазиций по пациенту"
                              params="" roles="/Policy/Mis/MedCase/Protocol/Create"/>
                <msh:sideLink styleId="viewShort" action="/javascript:viewOtherPreHospOphtByPatient('.do')"
                              name='Введение ингибиторов ангиогенеза'
                              title="Просмотр направлений на введение ингибиторов ангиогенеза" params=""
                              roles="/Policy/Mis/MedCase/Stac/Ssl/Planning/Opht/View"/>
                <msh:sideLink styleId="viewShort" action="/javascript:viewOtherExtMedserviceByPatient('.do')"
                              name='Внешние лаб. исследования' title="Просмотр внешних лабораторных данных по пациенту"
                              params="" roles="/Policy/Mis/MedCase/Document/External/Medservice/View"/>
                <msh:sideLink
                        roles="/Policy/Mis/MedCase/Stac/Ssl/SurOper/ShowSls,/Policy/Mis/MedCase/Stac/Ssl/SurOper/View"
                        name="Операции"
                        params="id"
                        action='/javascript:getDefinition("entityParentList-stac_surOperation.do?short=Short&id=${param.id}", null);'
                        title='Операции'
                        styleId="viewShort"
                />
                <msh:sideLink styleId="viewShort" action="/javascript:viewAssessmentCardsByVisit('.do')"
                              name="Карты оценки" title="Показать все карты оценки"
                              roles="/Policy/Mis/AssessmentCard/View"/>
            ...
            <msh:tableNotEmpty name="info_print_list">
                <msh:sideMenu title="Печать">
                    <msh:sideLink action="/javascript:printVisit('.do')" name="Визита" title="Печать визита" key="ALT+8"
                                  params="" roles="/Policy/Mis/MedCase/Visit/PrintVisit"/>
                    <msh:sideLink params="id" action="/print-talon_amb.do?s=VisitPrintService&amp;m=printTalon"
                                  key="ALT+9" name="Талона" title="Печать талона"
                                  roles="/Policy/Mis/MedCase/Visit/PrintTalon"/>
                    <msh:sideLink params="id" action="/print-talon_amb_short.do?s=VisitPrintService&amp;m=printTalon"
                                  name="Укороченного талона" title="Печать короткой версии талона"
                                  roles="/Policy/Mis/MedCase/Visit/PrintShortTalon"/>
                    <msh:sideLink roles="/Policy/Mis/MedCase/Visit/PrintBakExp" params="id"
                                  action="/print-BakExp.do?s=VisitPrintService&amp;m=printBakExp"
                                  name="Направления на бак.исследование"/>
                    <msh:sideLink roles="/Policy/Mis/MedCase/Stac/Ssl/View" action="/javascript:printAgree();"
                                  key="SHIFT+9" name="Информ. согласие на мед. вмешательство"
                                  title="Печать информационного согласия"/>
                    <tags:diary_parameterCreate document="документа"
                                                roles="/Policy/Mis/MedCase/Document/Internal/Create"
                                                action="doc_create_type.do?id=${param.id}" name="type" title="Документа"
                                                vocName="documentType"/>
                </msh:sideMenu>
            </msh:tableNotEmpty>
    ...
    <tiles:put name="javascript" type="string">
        ...
        <msh:ifFormTypeIsNotView formName="smo_visitForm">
            ...
            <msh:ifInRole roles="/Policy/Mis/MedCase/Visit/SetPayed">
                <script type="text/javascript">
                    function setPayed() {
