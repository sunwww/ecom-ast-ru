  ...
  %>
    ...
    <msh:panel>
      ...
      <msh:row>
        ...
        <msh:row>
        	<msh:autoComplete property="orderLpu" vocName="mainLpu" label="Внеш направитель"
        		horizontalFill="true" fieldColSpan="9" size="70"/>
        </msh:row>
        <msh:row>
...
ActionUtil.setParameterFilterSql("orderLpu","smo.orderLpu_id", request) ;
...
${specialistSql} ${is039Sql} ${workFunctionSql} ${lpuSql} 
    ...
    <msh:sectionContent>
        <msh:table printToExcelButton="Сохранить в excel"
         name="journal_ticket" action="entitySubclassView-mis_medCase.do" idField="1" noDataMessage="Не найдено">
            ...
            <msh:tableColumn columnName="у.е" property="15"/>
        </msh:table>
    </msh:sectionContent>
