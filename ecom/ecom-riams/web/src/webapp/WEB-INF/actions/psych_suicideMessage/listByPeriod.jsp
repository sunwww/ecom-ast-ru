...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true" >
  ...
  <tiles:put name="title" type="string">
    <msh:title guid="helloItle-123" mainMenu="PolyJournal" title="Сводная информация о случаях суицидальных попытках"/>
  </tiles:put>
  ...
  %>
    <msh:form action="/psych_suicideMessage_by_period.do" defaultField="dateBegin" disableFormDataConfirm="true" method="GET" guid="d7b31bc2-38f0-42cc-8d6d-19395273168f">
