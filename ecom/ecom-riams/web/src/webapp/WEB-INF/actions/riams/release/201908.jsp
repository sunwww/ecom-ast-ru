			...
			<tr>
				...
				<h1>Август 2019 года</h1>
                    ...
                    <ul>
						...
						<li> * В протокол операции добавлен протокол периоперационной антибиотикопрофилактики. Если отмечено "Да", то поля <u>класс раны</u>, <u>препарат</u>
                            обязательны всегда. Если выбран <u>препарат</u> (если препарат не нужен, выбрать "Нет"), то поля <u>доза</u>, <u>путь введения</u> и <u>время первой дозы</u> обязательны.
					...
					<h2>Лаборатория:</h2>
					<ul>
						<li> * Вывод ФИО лабораторного техника, выполнившего анализ/отбраковавшего назначение, в дневник с результатом </li>
					</ul>
					<h2>ЕДКЦ:</h2>
					<ul>
