	...
	<tiles:put name='body' type='string'>
		<table class='mainMenu'>
			<tr>
				...
				<ul>
					<li></li>
					<li>Удаление данных выписки. Могут удалять:</li>
						<ul>
							<li> - <b>любую выписку - КЭО</b></li>
							<li> - <b>только для НЕИНФЕКЦИОННЫХ отделений и в течение одного КАЛЕНДАРНОГО дня:</b></li>
								<ul>
									<li> - <b>пользователи с соответствующей ролью (зав. отделений)</b></li>
									<li> - <b>лечащий врач последнего СЛО</b></li>
								</ul>
						</ul>
                    ...
                    <li>Механизм выполнения ПЦР-анализов на SARS-COV2 лабораторией ГБУЗ АО АМОКБ:</li>
						<ul>
							...
							<li> - добавлен фильр по причине брака в передаче биоматериала в лабораторию</li>
							<li> - реализована возможность отмены брака для администраторов</li>
							<li> - формирование и печать реестра направленных на SARS-COV2</li>
						</ul>
					<li></li>
				</ul>
					</div>
