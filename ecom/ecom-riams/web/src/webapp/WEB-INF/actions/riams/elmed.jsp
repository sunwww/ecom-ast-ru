...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="javascript" type="string">
        ...
        <script type='text/javascript' src='./dwr/interface/ExternalService.js'></script>
        <script type="text/javascript">
            ...
            function getData(urlAppend, typePost, data, handler) {
                ExternalService.makeRequest(elmedUrl + urlAppend, typePost, data, {
            ...
            function makeImport(fileName) {
                ExternalService.makeRequest(elmedUrl + "/importFile?file=" + fileName,
                    "GET", null, {
                        callback: function (jso) {
                            let str = "";
