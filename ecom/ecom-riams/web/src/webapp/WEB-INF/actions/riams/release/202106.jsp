                ...
                <td class='col1'>
                    <div class='menu'>
                        ...
                        <ul>
                            ...
                            <li> - В печати направлений на COVID добавлен вывод номера истории, в шаблон добавлен код
                                исследования
                            </li>
                            <li> - В журнале обращений:
                            <li></li>
                            <ul>
                                <li> - вместо паспортных данных выводятся поток обслуживания и полис
                                </li>
                                <li> - в выборку пациентов в реанимации добавлены столбцы "Кол-во к.дней СЛО",
                                    "Диагноз", "Поток обслуживания и полис", "Профиль койки"
                                </li>
                            </ul>
                            </li>
                        </ul>
