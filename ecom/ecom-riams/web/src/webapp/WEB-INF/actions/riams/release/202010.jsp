			...
			<tr>
				...
				<ul>
					...
					<ul>
						...
						<li>- в форму COVID-19 добавлен основной выписной диагноз, недоступный для редактирования.
							Он заполняется автоматически при выписке пациента</li>
						<li>- печать повторной формы 058</li>
						<li>- запрос на удаление карты</li>
						<li>- разделение кнопок работы с картой по этапам</li>
                        <li>- печать выписной формы 058</li>
					</ul>
                    <li>- Печать рестров (первичного, повторного и при выписке)</li>
                    <li>- Печать журнала состоящих по инфекционным госпиталям</li>
					<li>- Печать журнала учёта инфекционных заболеваний</li>
					<li>- Настройка запрета ручного создания браслета</li>
					<li></li>
				</ul>
					</div>
			</tr>
