                ...
                <td class='col1'>
                    <div class='menu'>
                        ...
                        <ul>
                            ...
                            <li>Ограничение на дату выписки: выписывать можно только текущим числом либо умерших - вчерашней датой</li>
                            <li>Функционал обновления старых СЛО</li>
                            <li>Карта ведения роженицы в родильном отделении</li>
                            <li>Печать карт по беременности</li>
                            <li>Вывод карт по беременности в СЛО</li>
                        </ul>
                    </div>
            </tr>
        </table>
