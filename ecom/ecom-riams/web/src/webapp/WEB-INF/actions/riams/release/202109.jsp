                ...
                <td class='col1'>
                    <div class='menu'>
                        ...
                        <ul>
                            ...
                            <li>
                                - На странице настроек сделаны 2 ссылки для обновления данных ФОМС пациентов: для
                                записанных на дату и госпитализированных в течение последнего месяца: "Синхронизация с
                                базой ФОМС пациентов, записанных на завтра (поликлиника)" и "Синхронизация с базой ФОМС
                                пациентов стационара за последний месяц"
                            </li>
                            <li>
