			...
			<tr>
				...
				<ul>
					...
					<ul>
						...
						<li> * Реализован функционал комплексных услуг для стационара </li>
						<li> * Реализован функционал направления пациентов на исследование на ВИЧ (Журнал обращений->Направление на ВИЧ).
								Необходимо выбрать код контингента, ввести дату забора крови и регистрационный номер пациентов, которых необходимо направить.
								После этого нажать "Печать направления"</li>
					</ul>
					<h2>ЕДКЦ:</h2>
					<ul>
