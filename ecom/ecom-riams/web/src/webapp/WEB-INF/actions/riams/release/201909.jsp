			...
			<tr>
				...
				<ul>
					...
					<ul>
						...
						<li> * Реализован функционал направления пациентов на исследование на СПИД (Журнал обращений->Направление на СПИД).
								Необходимо выбрать код контингента и ввести дату забора крови пациентов, которых необходимо направить.
