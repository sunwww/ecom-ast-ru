<%@ page import="ru.ecom.ejb.services.quickquery.response.QuickQuery" %>
<%@ page import="ru.ecom.ejb.services.quickquery.response.QuickQueryResponse" %>
<%@ page import="ru.ecom.ejb.services.quickquery.response.QuickQueryRow" %>
