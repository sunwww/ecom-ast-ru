...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
    ...
    <tiles:put name='body' type='string'>
        <msh:form action="entityParentSaveGoView-edkcProtocolPregnant.do" defaultField="dateRegistration"
            ...
            <msh:panel>
                ...
                <msh:row>
                    <msh:ifFormTypeIsNotView formName="edkcProtocolPregnantForm">
                ...
                <msh:ifFormTypeIsView formName="edkcProtocolPregnantForm">
    ...
    <tiles:put name='side' type='string'>
        ...
        <msh:sideMenu>
                ...
                <msh:sideLink roles="/Policy/Mis/MedCase/Protocol/Edit" key="ALT+2"
                              params="id" action="/entityParentEdit-edkcProtocolPregnant"
                              name="Редактировать" />

                <msh:sideLink roles="/Policy/Mis/MedCase/Protocol/Delete"
                              key='ALT+DEL' params="id"
                              action="/entityParentDeleteGoParentView-edkcProtocolPregnant"
    ...
    <tiles:put name='title' type='string'>
        <ecom:titleTrail mainMenu="Expert2Pregnant" beginForm="edkcProtocolPregnantForm"/>
    </tiles:put>
    <tiles:put name='javascript' type='string'>
        <script type="text/javascript" src="./dwr/interface/PatientService.js">/**/</script>
        <msh:ifFormTypeIsCreate formName="edkcProtocolPregnantForm">
