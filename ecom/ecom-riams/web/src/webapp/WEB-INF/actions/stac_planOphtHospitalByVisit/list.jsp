...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
    ...
    <tiles:put name="title" type="string">
        <ecom:titleTrail beginForm="smo_visitForm" mainMenu="Patient" title="Список всех планирований введения ангиогенеза" guid="40efbd1b-4177-47a8-9aad-1971732f3f98" />
    </tiles:put>
    <tiles:put name="side" type="string">
        <msh:sideMenu guid="helloSideMenu-123" title="Добавить">
            <msh:sideLink params="id" action="/entityParentPrepareCreate-stac_planOphtHospitalByVisit" name="Добавить планирование введения ангиогенеза" title="Добавить планирование введения ангиогенеза" guid="2209b5f9-4b4f-4ed5-b825-b66f2ac57e87" roles="/Policy/Mis/MedCase/Stac/Ssl/Planning/Opht/Create" key="ALT+N" />
        </msh:sideMenu>
    </tiles:put>
...
where wct.visit_id='${param.id}'"/>
        <msh:table name="list" action="entityParentView-stac_planOphtHospitalByVisit.do" idField="1" guid="b621e361-1e0b-4ebd-9f58-b7d919b45bd6">
