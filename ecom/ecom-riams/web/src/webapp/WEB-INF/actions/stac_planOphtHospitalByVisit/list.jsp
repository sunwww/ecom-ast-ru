...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true" >
    ...
    <tiles:put name="title" type="string">
        <ecom:titleTrail beginForm="smo_visitForm" mainMenu="Patient" title="Список всех планирований введения ангиогенеза в визите" guid="40efbd1b-4177-47a8-9aad-1971732f3f98" />
    </tiles:put>
