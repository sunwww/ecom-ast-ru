...
<tiles:insert page="/WEB-INF/tiles/main${param.short}Layout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        -->
        <msh:form action="/entityParentSaveGoView-stac_sslDischargePre.do" defaultField=""
            ...
            <msh:panel colsWidth="5%,10%,5%,80%">
                ...
                <mis:ifPatientIsWoman classByObject="Patient" idObject="stac_sslDischargePreForm.patient"
                    ...
                    <msh:row>
                        <msh:autoComplete viewOnlyField="true" viewAction="entityParentView-preg_pregnancy.do"
                                          property="pregnancy" label="Беременность" fieldColSpan="3"
                                          parentId="stac_sslAdmissionForm.patient" vocName="pregnancyByPatient"
                                          horizontalFill="true"/>
                    </msh:row>
                        ...
                        <msh:ifFormTypeIsNotView formName="stac_sslDischargePreForm">
                            <msh:row>
                                <td colspan="4" align="center">
                                    ...
                                    <input type="button" value="Сохранить пред. выписку+диагноз"
                                           onclick="this.form.action='entityParentSaveGoView-stac_sslDischargePre.do';this.form.submit();"/>
            ...
            <msh:panel colsWidth="5%,10%,5%,80%">
                ...
                <msh:row>
                    <msh:autoComplete property="kinsman" label="Представитель (иног.)"
                                      ...
                                      parentId="stac_sslDischargePreForm.patient" vocName="kinsmanBySMO"
        ...
        <msh:ifNotInRole roles="/Policy/Mis/MedCase/Stac/Ssl/Discharge/NotViewDischargeEpicrisis">
            <msh:ifFormTypeIsNotView formName="stac_sslDischargePreForm">
                <tags:templateProtocol property="dischargeEpicrisis" name="Text" version="Visit"
                                       idSmo="stac_sslDischargePreForm.id" voc="protocolVisitByPatient"/>
