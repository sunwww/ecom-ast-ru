...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        <msh:form action="/entitySaveGoView-work_workFunction.do" defaultField="hello">
            ...
            <msh:panel>
                <msh:row>
                    <msh:autoComplete vocName="vocWorkFunction" property="workFunction" fieldColSpan="3"
                                      label="Название функции" size="50"/>
                </msh:row>
                <msh:autoComplete viewAction="userView.do" vocName="secUser" property="secUser" label="Вход в систему"
    ...
    <tiles:put name="side" type="string">
        <msh:ifFormTypeIsView formName="work_workFunctionForm">
            <msh:sideMenu title="Рабочая функция">
                <msh:sideLink key="ALT+2" params="id" action="/entityEdit-work_workFunction" name="Изменить"
                              roles="/Policy/Mis/Worker/WorkFunction/Create"/>
                <msh:sideLink key="ALT+DEL" confirm="Удалить?" params="id"
                              action="/entityParentDeleteGoParentView-work_workFunction" name="Удалить"
