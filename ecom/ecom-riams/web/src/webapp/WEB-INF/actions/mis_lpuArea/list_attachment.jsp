    ...
    <tiles:put name="body" type="string">
        ...
        <msh:form action="/mis_attachment.do" defaultField="lpuName" disableFormDataConfirm="true">
            <msh:panel>
                ...
                <msh:row>
                    <msh:autoComplete property="lpu" vocName="lpu" label="ЛПУ" viewAction="entityEdit-mis_lpu.do"
                                      fieldColSpan="7" horizontalFill="true"/>
                </msh:row>
                <msh:row styleId='rowCompany'>
                    <msh:autoComplete fieldColSpan="3" property="company" label="Страховая&nbsp;компания"
                                      horizontalFill="true"
                ...
                <msh:row>
                    <td class="label" title="Возраст  (typeAge)" colspan="1"><label for="typeAgeName" id="typeAgeLabel">Возраст:</label>
                    </td>
                ...
                <msh:row>
                    <td class="label" title="Прикрепление  (typeAttachment)" colspan="1"><label for="typeAttachmentName"
                                                                                                id="typeAttachmentLabel">Прикрепление:</label>
                    </td>
                    <td onclick="this.childNodes[1].checked='checked';">
            ...
            <msh:panel colsWidth="fondTable">
                ...
                <msh:row>
                    <td class="label" title="Участок  (typeAreaCheck)" colspan="1"><label for="typeAreaCheckName"
                                                                                          id="typeAreaCheckLabel">Прикрепление
                        к участку:</label></td>
                    <td onclick="this.childNodes[1].checked='checked';">
            ...
            <msh:panel colsWidth="systemTable">
                ...
                <msh:row>
                    <td class="label" title="Отобразить  (typeDefect)" colspan="1"><label for="typeDefectName"
                                                                                          id="typeDefectLabel">Отображать:</label>
                    </td>
                    <td onclick="this.childNodes[1].checked='checked';">
                ...
                <msh:row>
                    <td class="label" title="Список  (typeChange)" colspan="1"><label for="typeChangeName"
                                                                                      id="typeChangeLabel">Список:</label>
                    </td>
                    <td onclick="this.childNodes[1].checked='checked';">
                ...
                <msh:row>
                    <td class="label" title="Разбивать по СК  (typeDivide)" colspan="1"><label for="typeDivideName"
                                                                                               id="typeDivideLabel">Разбивать
                        по СК:</label></td>
                    <td onclick="this.childNodes[1].checked='checked';">
                ...
                <msh:row>
                    <td class="label" title="Пациенты  (typeView)" colspan="1"><label for="typeViewName"
                                                                                      id="typeViewLabel">Отображать
                        пациентов:</label></td>
                    <td onclick="this.childNodes[1].checked='checked';">
                ...
                <msh:row>
                    <td class="label" title="Страх. компания  (typeCompany)" colspan="1"><label for="typeCompanyName"
                                                                                                id="typeCompanyLabel">Страховая
                        компания:</label></td>
                    <td onclick="this.childNodes[1].checked='checked';">
                ...
                <msh:row>
                    <td class="label" title="Пациенты  (typeRead)" colspan="1"><label for="typeReadName"
                ...
                <msh:row styleId="typeResultDiv">
                    ...
                    <td class="label" title="Пациенты  (typeResult)" colspan="1"><label for="typeResultName"
                ...
                <msh:row styleId="typeDispPlan">
                    ...
                    <td class="label" title="Пациенты  (typeDispPlan)" colspan="1"><label for="typeDispPlanName"
                                                                                          id="typeDispPlanLabel">Формировать:</label>
                    </td>
                    <td onclick="this.childNodes[1].checked='checked';">
                ...
                <msh:row>
                    <td colspan="11"><label>Импорт дефектов: </label>
                        <input type="file" name="filenameDefect" id="filenameDefect" size="50" value="Импорт дефектов"
                               onchange="importDefects(event)">
            ...
            <msh:table viewUrl="entityParentView-mis_lpuAttachedByDepartment.do"
                       editUrl="entityParentView-mis_lpuAttachedByDepartment.do"
                       deleteUrl="entityParentDeleteGoParentView-mis_lpuAttachedByDepartment.do" name="defectWQR"
                       action="entityView-mis_lpuAttachedByDepartment.do" idField="2" noDataMessage="Не найдено">
        ...
        <msh:table viewUrl="entityParentView-mis_lpuAttachedByDepartment.do"
                   editUrl="entityParentView-mis_lpuAttachedByDepartment.do"
                   deleteUrl="entityParentDeleteGoParentView-mis_lpuAttachedByDepartment.do" name="journal_ticket"
                   action="entityView-mis_lpuAttachedByDepartment.do" idField="1" noDataMessage="Не найдено">
