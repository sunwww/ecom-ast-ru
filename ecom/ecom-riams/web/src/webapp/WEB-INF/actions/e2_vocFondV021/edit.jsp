...
<tiles:insert page="/WEB-INF/tiles/mainLayout.jsp" flush="true">
    ...
    <tiles:put name="body" type="string">
        ...
        <msh:ifFormTypeIsView formName="e2_vocFondV021Form">
            ...
            <ecom:webQuery name="simpeServiceList" nativeSql="select link.id, ms.code||' '||ms.name
            from MedServiceComplexLink link
             left join medservice ms on ms.id=link.innerMedService_id where link.speciality_id=${param.id}"/>
