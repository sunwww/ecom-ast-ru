...
public class EntityWebTrailTag extends AbstractGuidSimpleSupportTag {
    ...
    public void setMainMenu(String aMainMenu) {
        theMainMenu = aMainMenu;
    }
    ...
    public void setBeginForm(String aBeginForm) {
        theBeginForm = aBeginForm;
    }
...
//            String id = request.getParameter("id") ;
            ...
            if (formBeanConfig == null)
                throw new IllegalStateException("Не найдена конфигурация для формы " + theBeginForm);
...
//                	IEntityForm form  ;
    ...
    private void printLi(StringBuilder aSb, StringBuilder aSbTitle, String aValue, String aComment, Object aId, String aDefaultViewAction
        ...
        if (firstIsLink) {
            ...
            if (aDefaultViewAction.indexOf('?') < 0) {
                aSb.append("?id=");
            } else {
                aSb.append("&id=");
            }
        ...
        if (firstIsLink && aDefaultShortAction != null && !aDefaultShortAction.equals("")) {
            ...
            if (aDefaultShortAction.indexOf('?') < 0) {
                aSb.append("?id=");
            } else {
                aSb.append("&id=");
            }
