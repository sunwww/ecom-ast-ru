...
public class AttachmentServiceJs {
    ...
    public String getAreaByPatient(Long aPatientId, HttpServletRequest aRequest) throws NamingException {
        ...
        try {
            ...
            if (!res.isEmpty()) {
                ...
                String lpuId = r.get3() != null ? r.get3().toString() : "", lpuName = r.get4() != null ? r.get4().toString() : "", areaId = r.get1() != null ? r.get1().toString() : "", areaName = r.get2() != null ? r.get2().toString() : "", companyId = r.get5() != null ? r.get5().toString() : "", companyName = r.get6() != null ? r.get6().toString() : "", attachedType = r.get7() != null ? r.get7().toString() : "";
    ...
    public String changeArea(long aOldAreaId, long aNewLpuId, long aNewAreaId, HttpServletRequest aRequest) throws NamingException {
        return Injection.find(aRequest).getService(ISyncAttachmentDefectService.class).changeAttachmentArea(aOldAreaId, aNewLpuId, aNewAreaId);
