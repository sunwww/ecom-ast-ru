...
public class PregnancyServiceJs {
    ...
    public void moveChildBirth(Long sloFrom, Long sloTo, HttpServletRequest aRequest) throws NamingException {
        ...
        service.executeUpdateNativeSql("update calculationsresult set departmentmedcase_id=" + sloTo + " where calculator_id=(select id from calculator where vteo=true limit 1) and departmentmedcase_id=" + sloFrom); //риск ВТЭО
