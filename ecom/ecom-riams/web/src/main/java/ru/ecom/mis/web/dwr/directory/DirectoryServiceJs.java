...
public class DirectoryServiceJs {
    ...
    public boolean updateEntryEdit(String aJson, HttpServletRequest aRequest) throws NamingException {
        ...
        Long buildingId, misLpuId, buildingLevelId;
    ...
    private void insertTelephoneNumbers(HttpServletRequest aRequest, JSONObject obj, Long entryId) {
        ...
        try {
            ...
            if (obj.has("numbers")) {
                JSONArray params = obj.getJSONArray("numbers");
                for (int i = 0; i < params.length(); i++) {
    ...
    // Добавление записи
    public void setEntryAndNumber(String aJson, HttpServletRequest aRequest) throws NamingException {
        JSONObject obj = new JSONObject(aJson);
        JSONArray params = null;
