...
public class FondWebService {
    private static final String theAddress = "vipnet";
    ...
    private static boolean isTrue(String str) {
        return str != null && (str.equals("1") || str.equalsIgnoreCase("true") || str.equalsIgnoreCase("on"));
    }
    ...
    public static String checkAllPatientsByFond(String updPatient, String updDocument, String updPolicy, String updAttachment, String aType, String aPatientList, HttpServletRequest aRequest) {
        ...
        updatePatient = isTrue(updPatient);
        updateDocument = isTrue(updDocument);
        updatePolicy = isTrue(updPolicy);
        updateAttachment = isTrue(updAttachment);
        try {
            ...
            if (!pats.isEmpty()) {
                ...
                for (WebQueryResult pat : pats) {
                    i++;
                    String pid = pat.get1().toString();
                    String lastname = pat.get2().toString();
                    String firstname = pat.get3().toString();
                    String middlename = pat.get4().toString();
                    String birthday = pat.get5().toString();
                    String resultRZ;
                    ...
                    if (!aRz.equals("")) {
                        ...
                        String snils = null;
                        String attachedDate = null;
                        String attachedType = null;
                        String attachedLpu = null;
                        String doctorSnils = null;
                        String codeDepartment = null;
                        ...
                        for (Element e : list_cur) {
                            ...
                            lastname = e.getChildText("f");
                            firstname = e.getChildText("i");
                            middlename = e.getChildText("o");
                            birthday = upDate(e.getChildText("dr"));
                            snils = e.getChildText("ss");
                            attachedDate = upDate(e.getChildText("date_prik"));
                            attachedType = e.getChildText("sp_prik");
                            attachedLpu = e.getChildText("lpu");
                            doctorSnils = e.getChildText("ssd");
                            codeDepartment = e.getChildText("kodpodr");
                        ...
                        String documentDateIssued = null;
                        String documentWhomIssued = null;
                        Date maxDate = null;
                        for (Element el : list_cur) {
                            ...
                            if (maxDate == null || currentDocDate.getTime() > maxDate.getTime()) {
                                ...
                                documentType = el.getChildText("doc_t");
                                documentSeries = el.getChildText("doc_s");
                                documentNumber = el.getChildText("doc_n");
                                documentDateIssued = upDate(el.getChildText("doc_d"));
                                documentWhomIssued = el.getChildText("doc_v");
    ...
    private static String getInfoByPatient(HttpServletRequest aRequest, PatientForm aPatFrm, WS_MES_SERVERSoapPort aSoap, String aRz, Long patId) throws JDOMException, IOException, NamingException, ParseException {
        if (!aRz.equals("")) {
            ...
            String defaultLpu = list.isEmpty() ? null : list.iterator().next().get1().toString();
            ...
            for (Element e : list_cur) {
                ...
                if (isStart) {
                    ...
                    codeDepartment = e.getChildText("kodpodr");
                    attachedLpu = attLpu;
                    attachedDate = attDate;
                    attachedType = attType;
                }
            }
            sb.append("</table>");
