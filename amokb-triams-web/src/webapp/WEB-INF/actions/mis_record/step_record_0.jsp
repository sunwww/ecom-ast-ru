...
//		       	            theFieldError = errorutil.HideError(theElement) ;
	       	...
	       	function fn_not_data_patient() {
	       		setwwaitingMessage('Предварительно Вам надо оформить мед.карту в регистратуре, после чего Вы сможете записываться к врачу по инфомату.<br/> Вы хотите оформить предварительную запись к врачу?'
