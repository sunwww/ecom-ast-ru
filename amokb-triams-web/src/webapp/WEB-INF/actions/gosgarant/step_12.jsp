...
<tiles:insert page="/WEB-INF/tiles/main${param.infomat}Layout.jsp" flush="true">
    ...
    <FONT COLOR="#26282f"><B>Приложение N 12<BR>к </B></FONT><FONT COLOR="#106bbe"><B>Программе</B></FONT></P>
<P CLASS="western" STYLE="margin-bottom: 0cm"><BR>
</P>
<H1 CLASS="western">Перечень<BR>лекарственных препаратов, отпускаемых
...
отпускаются по рецептам врачей бесплатно, а также в соответствии с
...
<TABLE WIDTH=675 BORDER=1 BORDERCOLOR="#000000" CELLPADDING=7 CELLSPACING=0>
	...
	<TR VALIGN=TOP>
		...
		<TD WIDTH=170>
			...
			модифицированным высвобождением, покрытые пленочной оболочкой</P>
		</TD>
	</TR>
	<TR VALIGN=TOP>
		<TD WIDTH=475>
...
<P CLASS="western" STYLE="margin-bottom: 0cm">_________________________</P>
<P CLASS="western" STYLE="margin-bottom: 0cm"><A NAME="sub_1201"><FONT COLOR="#26282f"><B>*</B></FONT>
- назначаются только по решению врачебной комиссии медицинской
организации.</P>
<P CLASS="western" STYLE="margin-bottom: 0cm"><BR>
</P>
<P CLASS="western" STYLE="margin-bottom: 0cm">Назначение и применение
лекарственных препаратов для медицинского применения и медицинских
изделий, не входящих в стандарты медицинской помощи, допускаются в
случае наличия медицинских показаний (индивидуальной непереносимости,
по жизненным показаниям) по решению врачебной комиссии (в
соответствии с <FONT COLOR="#106bbe"><B>частью
5 статьи 37</B></FONT> Федерального закона от 21.11.2011 N 323-ФЗ
