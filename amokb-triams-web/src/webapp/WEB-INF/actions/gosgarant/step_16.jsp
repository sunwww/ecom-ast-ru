...
<tiles:insert page="/WEB-INF/tiles/main${param.infomat}Layout.jsp" flush="true">
    ...
    <FONT COLOR="#26282f"><B>Приложение N 16<BR>к </B></FONT><FONT COLOR="#106bbe"><B>Программе</B></FONT></P>
<P CLASS="western" STYLE="margin-bottom: 0cm"><BR>
</P>
<H1 CLASS="western">Условия<BR>размещения пациентов в маломестных
палатах (боксах) по медицинским и (или) эпидемиологическим
показаниям, установленным Министерством здравоохранения Российской
Федерации</H1>
<P CLASS="western" STYLE="margin-bottom: 0cm"><BR>
</P>
<P CLASS="western" STYLE="margin-bottom: 0cm">К <FONT COLOR="#106bbe"><B>медицинским
показаниям</B></FONT> к размещению пациентов в маломестных
палатах (боксах) относятся показания, утвержденные <FONT COLOR="#106bbe"><B>приказом</B></FONT>
Министерства здравоохранения и социального развития Российской
Федерации от 15.05.2012 N 535н &quot;Об утверждении перечня
...
показаниями к размещению пациентов в маломестных палатах (боксах)
являются инфекционные и паразитарные болезни согласно кодам МКБ-Х:
<FONT COLOR="#106bbe"><B>А00-А99</B></FONT>,
<FONT COLOR="#106bbe"><B>В00-В19</B></FONT>,
<FONT COLOR="#106bbe"><B>В25-В83</B></FONT>,
<FONT COLOR="#106bbe"><B>В85-В99</B></FONT>.</P>
